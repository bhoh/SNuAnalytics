...
public:
  ...
  void SetHadronicTopBJets(TLorentzVector jet_, double resolution_, std::vector<TLorentzVector> fsr_jet_, std::vector<double> fsr_resolution_); // it doesn't check tagging status
  void SetLeptonicTopBJets(TLorentzVector jet_, double resolution_, std::vector<TLorentzVector> fsr_jet_, std::vector<double> fsr_resolution_); // it doesn't check tagging status
  void SetWCHUpTypeJets(TLorentzVector jet_, double resolution_, std::vector<TLorentzVector> fsr_jet_, std::vector<double> fsr_resolution_); // u/c jet from W(H+)
  void SetWCHDownTypeJets(TLorentzVector jet_, double resolution_, std::vector<TLorentzVector> fsr_jet_, std::vector<double> fsr_resolution_); // d/s/b jet from W(H+)

  void SetExtraJets(std::vector<TLorentzVector> extra_jet_, std::vector<double> extra_resolution_);
...
private:
  ...
  double CalcEachChi2(std::vector<TFitParticlePt*> ptrs);
  ...
  std::vector<TFitParticlePt*> fit_hadronic_top_b_jet;
  std::vector<TFitParticlePt*> fit_leptonic_top_b_jet;
  std::vector<TFitParticlePt*> fit_hadronic_w_ch_jet1;
  std::vector<TFitParticlePt*> fit_hadronic_w_ch_jet2;
