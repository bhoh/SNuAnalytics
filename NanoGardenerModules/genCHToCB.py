...
class genCHToCB(Module):
    ...
    def analyze(self, event):
        ...
        self.out.fillBranch("had_top_b_matched_jet_idx",         top_b_matched_jet_idx if gen_had_top_sign>0 else anti_top_b_matched_jet_idx )
        self.out.fillBranch("lep_top_b_matched_jet_idx",         anti_top_b_matched_jet_idx if gen_had_top_sign>0 else top_b_matched_jet_idx )
