...
Steps['HMlnjjVars_Dev_jhchoi11_nom'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
    ...
    'do4MC': True,
    'do4Data': True,
    'import': 'LatinoAnalysis.NanoGardener.modules.HMlnjjVars_Dev_jhchoi11',
    'declare': 'hmlnjjvar = lambda:HMlnjjVarsClass_Dev(year=RPLME_YEAR,METtype="PuppiMET",fjsysvars=["nom"],jetsysvars=["nom"],pairalgos=["dMchi2Resolution","dM"])',
    'module':  'hmlnjjvar()',
...
Steps['HMlnjjVars_Dev_jhchoi11_test'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
    ##Use for data/nom
    'isChain': False,
    'do4MC': True,
    'do4Data': True,
    'import': 'LatinoAnalysis.NanoGardener.modules.HMlnjjVars_Dev_jhchoi11_test',
    'declare': 'hmlnjjvar = lambda:HMlnjjVarsClass_Dev(year=RPLME_YEAR,METtype="PuppiMET",fjsysvars=["nom"],jetsysvars=["nom"],pairalgos=["dMchi2Resolution","dM"])',
    'module':  'hmlnjjvar()',

}
Steps['HMlnjjVars_Dev_jhchoi11_sys'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_Dev_jhchoi11_jetsys'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_Dev_jhchoi11_jetsysup'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_Dev_jhchoi11_jetsysdown'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_Dev_jhchoi11_jetsysup_correlate'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_Dev_jhchoi11_jetsysdown_correlate'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_Dev_jhchoi11_jetsysup_uncorrelate'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_Dev_jhchoi11_jetsysdown_uncorrelate'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_Dev_jhchoi11_fatjetsys'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMFull_jhchoi11_nom']={
    ...
    'subTargets':['WlepMakerKR_nom','WtaggerProducer_nom','WjjtaggerProducer_nom','HMlnjjVars_Dev_jhchoi11_nom','BWReweight'],
...
Steps['HMFull_jhchoi11_sys']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsys','WtaggerProducer_fatjetsys','WjjtaggerProducer_jetsys','HMlnjjVars_Dev_jhchoi11_sys','BWReweight'],

}



Steps['HMFull_jhchoi11_jetsys']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsys','WtaggerProducer_nom','WjjtaggerProducer_jetsys','HMlnjjVars_Dev_jhchoi11_jetsys','BWReweight'],

}

Steps['HMFull_jhchoi11_jetsysup']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsysup','WtaggerProducer_nom','WjjtaggerProducer_jetsysup','HMlnjjVars_Dev_jhchoi11_jetsysup','BWReweight'],

}


Steps['HMFull_jhchoi11_jetsysdown']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsysdown','WtaggerProducer_nom','WjjtaggerProducer_jetsysdown','HMlnjjVars_Dev_jhchoi11_jetsysdown','BWReweight'],

}


Steps['HMFull_jhchoi11_jetsysup_correlate']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsysup_correlate','WtaggerProducer_nom','WjjtaggerProducer_jetsysup_correlate','HMlnjjVars_Dev_jhchoi11_jetsysup_correlate','BWReweight'],

}


Steps['HMFull_jhchoi11_jetsysdown_correlate']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsysdown_correlate','WtaggerProducer_nom','WjjtaggerProducer_jetsysdown_correlate','HMlnjjVars_Dev_jhchoi11_jetsysdown_correlate','BWReweight'],

}

Steps['HMFull_jhchoi11_jetsysup_uncorrelate']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsysup_uncorrelate','WtaggerProducer_nom','WjjtaggerProducer_jetsysup_uncorrelate','HMlnjjVars_Dev_jhchoi11_jetsysup_uncorrelate','BWReweight'],

}


Steps['HMFull_jhchoi11_jetsysdown_uncorrelate']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsysdown_uncorrelate','WtaggerProducer_nom','WjjtaggerProducer_jetsysdown_uncorrelate','HMlnjjVars_Dev_jhchoi11_jetsysdown_uncorrelate','BWReweight'],

}

Steps['HMFull_jhchoi11_fatjetsys']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_nom','WtaggerProducer_fatjetsys','WjjtaggerProducer_nom','HMlnjjVars_Dev_jhchoi11_fatjetsys','BWReweight'],

}


Steps['HMFull_jhchoi11_data']={
    'isChain':True,
    'do4MC':False,
    'do4Data':True,
    'subTargets':['WlepMakerKR_data','WtaggerProducer_data','WjjtaggerProducer_data','HMlnjjVars_Dev_jhchoi11_nom','BWReweight'],

}

Steps['HMFull_jhchoi11_data_test']={
    'isChain':True,
    'do4MC':True,
    'do4Data':True,
    'subTargets':['WlepMakerKR_data','WtaggerProducer_data','WjjtaggerProducer_data','HMlnjjVars_Dev_jhchoi11_test','BWReweight'],

}


Steps['HMFull_jhchoi11_nom_test']={
    'isChain':True,
    'do4MC':True,
    'do4Data':True,
    'subTargets':['WlepMakerKR_nom','WtaggerProducer_nom','WjjtaggerProducer_nom','HMlnjjVars_Dev_jhchoi11_test','BWReweight'],
...
Steps['HMlnjjVars_Dev_jhchoi11test'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_Dev_jhchoi11_sys_test'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMFull_sys_test']={
    ...
    'do4Data':False,
    'selection':'"Entry$ < 1000"',
    'subTargets':['WlepMakerKR','WtaggerProducer_fatjetsys','WjjtaggerProducer_sys','HMlnjjVars_Dev_jhchoi11_sys_test'],
...
Steps['HMFull_jhchoi11_data_test']={
    ...
    'do4Data':True,
    'selection':'"Entry$ < 10000"',
    'subTargets':['WlepMakerKR_data','WtaggerProducer_data','WjjtaggerProducer_data','HMlnjjVars_Dev_jhchoi11_nom'],
