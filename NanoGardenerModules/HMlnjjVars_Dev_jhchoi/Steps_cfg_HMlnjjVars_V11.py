...
Steps['HMlnjjVars_Dev_V11_nom'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
    ##Use for data/nom
    'isChain': False,
    'do4MC': True,
    'do4Data': True,#HMlnjjVars_V11
    'import': 'LatinoAnalysis.NanoGardener.modules.HMlnjjVars_V11',
    'declare': 'hmlnjjvar = lambda:HMlnjjVarsClass_Dev(year=RPLME_YEAR,METtype="PuppiMET",fjsysvars=["nom"],jetsysvars=["nom"],pairalgos=["dMchi2Resolution","dM"])',
    'module':  'hmlnjjvar()',

}

Steps['HMlnjjVars_V11_nom'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
    ##Use for data/nom
    'isChain': False,
    'do4MC': True,
    'do4Data': True,
...
Steps['HMlnjjVars_V11_test'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
    ##Use for data/nom
    'isChain': False,
    'do4MC': True,
    'do4Data': True,
    'import': 'LatinoAnalysis.NanoGardener.modules.HMlnjjVars_V11_test',
    'declare': 'hmlnjjvar = lambda:HMlnjjVarsClass_Dev(year=RPLME_YEAR,METtype="PuppiMET",fjsysvars=["nom"],jetsysvars=["nom"],pairalgos=["dMchi2Resolution","dM"])',
    'module':  'hmlnjjvar()',

}
Steps['HMlnjjVars_V11_sys'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_V11_jetsys'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_V11_jetsysup'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_V11_jetsysdown'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_V11_jetsysup_correlate'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_V11_jetsysdown_correlate'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_V11_jetsysup_uncorrelate'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_V11_jetsysdown_uncorrelate'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_V11_fatjetsys'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMFull_V11_nom']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,

    'subTargets':['WlepMakerKR_nom','WtaggerProducer_nom','WjjtaggerProducer_nom','HMlnjjVars_V11_nom'],
...
Steps['HMFull_V11_sys']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsys','WtaggerProducer_fatjetsys','WjjtaggerProducer_jetsys','HMlnjjVars_V11_sys',],

}



Steps['HMFull_V11_jetsys']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsys','WtaggerProducer_nom','WjjtaggerProducer_jetsys','HMlnjjVars_V11_jetsys',],

}

Steps['HMFull_V11_jetsysup']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsysup','WtaggerProducer_nom','WjjtaggerProducer_jetsysup','HMlnjjVars_V11_jetsysup',],

}


Steps['HMFull_V11_jetsysdown']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsysdown','WtaggerProducer_nom','WjjtaggerProducer_jetsysdown','HMlnjjVars_V11_jetsysdown',],

}


Steps['HMFull_V11_jetsysup_correlate']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsysup_correlate','WtaggerProducer_nom','WjjtaggerProducer_jetsysup_correlate','HMlnjjVars_V11_jetsysup_correlate',],
...
Steps['HMFull_V11_jetsysdown_correlate']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsysdown_correlate','WtaggerProducer_nom','WjjtaggerProducer_jetsysdown_correlate','HMlnjjVars_V11_jetsysdown_correlate',],
    'outputbranchsel': os.getenv('CMSSW_BASE') + '/src/SNuAnalytics/NanoGardenerFrameworks/HWWSemilepHM/20200318_SYS/semilep_branch_jhchoi.txt',
}

Steps['HMFull_V11_jetsysup_uncorrelate']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsysup_uncorrelate','WtaggerProducer_nom','WjjtaggerProducer_jetsysup_uncorrelate','HMlnjjVars_V11_jetsysup_uncorrelate',],
    'outputbranchsel': os.getenv('CMSSW_BASE') + '/src/SNuAnalytics/NanoGardenerFrameworks/HWWSemilepHM/20200318_SYS/semilep_branch_jhchoi.txt',
}


Steps['HMFull_V11_jetsysdown_uncorrelate']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_jetsysdown_uncorrelate','WtaggerProducer_nom','WjjtaggerProducer_jetsysdown_uncorrelate','HMlnjjVars_V11_jetsysdown_uncorrelate',],
    'outputbranchsel': os.getenv('CMSSW_BASE') + '/src/SNuAnalytics/NanoGardenerFrameworks/HWWSemilepHM/20200318_SYS/semilep_branch_jhchoi.txt',
}

Steps['HMFull_V11_fatjetsys']={
    'isChain':True,
    'do4MC':True,
    'do4Data':False,
    'subTargets':['WlepMakerKR_nom','WtaggerProducer_fatjetsys','WjjtaggerProducer_nom','HMlnjjVars_V11_fatjetsys',],

}


Steps['HMFull_V11_data']={
    'isChain':True,
    'do4MC':False,
    'do4Data':True,
    'subTargets':['WlepMakerKR_data','WtaggerProducer_data','WjjtaggerProducer_data','HMlnjjVars_V11_nom',],

}

Steps['HMFull_V11_data_test']={
    'isChain':True,
    'do4MC':True,
    'do4Data':True,
    'subTargets':['WlepMakerKR_data','WtaggerProducer_data','WjjtaggerProducer_data','HMlnjjVars_V11_test',],

}


Steps['HMFull_V11_nom_test']={
    'isChain':True,
    'do4MC':True,
    'do4Data':True,
    'subTargets':['WlepMakerKR_nom','WtaggerProducer_nom','WjjtaggerProducer_nom','HMlnjjVars_V11_test',],
...
Steps['HMlnjjVars_V11test'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMlnjjVars_V11_sys_test'] = {#    def __init__(self, year, METtype='PuppiMET',fjsysvars=['nom','jesup','jesdown','jerup','jerdown','jmsup','jmsdown','jmrup','jmrdown'],jetsysvars='all',pairalgos=['dMchi2Resolution','dM'], doSkim=False, doHardSkim=False):
...
Steps['HMFull_sys_test']={
    ...
    'do4Data':False,
    'selection':'"Entry$ < 1000"',
    'subTargets':['WlepMakerKR','WtaggerProducer_fatjetsys','WjjtaggerProducer_sys','HMlnjjVars_V11_sys_test'],
