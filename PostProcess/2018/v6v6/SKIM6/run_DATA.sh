...
mkPostProc.py -p Run2018_102X_nAODv6_Full2018v6 -i DATAl1loose2018v6 -s HMSemilepSkimJH2018v6_6_data -b -T ${SAMPLE_LIST}
#mkPostProc.py -p Run2018_102X_nAODv6_Full2018v6 -i DATAl1loose2018v6__HMSemilepSkimJH2018v6_6_data -s HMlnjjVars_Dev_jhchoi2 -b -T ${SAMPLE_LIST}
