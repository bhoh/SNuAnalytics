...
mkPostProc.py -p Autumn18_102X_nAODv6_Full2018v6 -i  MCl1loose2018v6__MCCorr2018v6 -s HMSemilepSkimJHv6_7 -b -T ${SAMPLE_LIST} 
mkPostProc.py -p Autumn18_102X_nAODv6_Full2018v6 -i  MCl1loose2018v6__MCCorr2018v6__HMSemilepSkimJHv6_7 -s HMlnjjVars_Dev_jhchoi7 -b -T ${SAMPLE_LIST} 
...
for sys in ${SYSLIST[@]};do
    ...
    echo "---$sys---"
    mkPostProc.py -p Autumn18_102X_nAODv6_Full2018v6 -i  MCl1loose2018v6__MCCorr2018v6__HMSemilepSkimJHv6_7 -s ${sys} -b -T ${SAMPLE_LIST}
done
