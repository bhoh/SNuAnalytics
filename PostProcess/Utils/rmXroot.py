...
if yesNo == 'yes':
  ...
  for afile in file_list:
    ...
    cmd = "xrdfs cms-xrdr.private.lo:2094 rm /xrd/store/user/jhchoi/Latino/HWWNano/Fall2017_102X_nAODv4_Full2017v5/MCl1loose2017v5__MCCorr2017v5__Semilep2017__HMlnjjSel2017/" + afile
    system(cmd)
