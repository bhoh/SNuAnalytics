...
SAMPLES=(VBFHToWWToLNuQQ_M125 VBFHToWWToLNuQQ_M1500)
#SAMPLES=(GluGluHToWWToLNuQQ_M125 GluGluHToWWToLNuQQ_M900)
EXCLUDE=()
...
#--l1Prod--#
mkPostProc.py -p Fall2017_102X_nAODv5_Full2017v6 -i Prod -s HighMassSemilepLHEAnalyzerVBF -b -T ${SAMPLE_LIST}
