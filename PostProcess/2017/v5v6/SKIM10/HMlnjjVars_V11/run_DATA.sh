...
#mkPostProc.py ${modcfg} -p Run2017_102X_nAODv5_Full2017v6 -i DATAl1loose2017v6__HMSemilepSKIMv6_10_data -s HMFull_V11_data -T SingleElectron_Run2017B-Nano1June2019-v1
mkPostProc.py ${modcfg} -p Run2017_102X_nAODv5_Full2017v6 -i DATAl1loose2017v6__HMSemilepSKIMv6_10_data -s HMFull_V11_data -b -T ${SAMPLE_LIST}
