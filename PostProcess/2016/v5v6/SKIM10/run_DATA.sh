...
#mkPostProc.py -p Run2016_102X_nAODv5_Full2016v6 -i DATAl1loose2016v6__HMSemilepSkimJHv6_7_data -b -s HMlnjjVars_Dev_jhchoi7 -T ${SAMPLE_LIST}
...
mkPostProc.py ${modcfg} -p Run2016_102X_nAODv5_Full2016v6 -i DATAl1loose2016v6__HMSemilepSKIMv6_10_data -s HMFull_jhchoi10_data -T ${SAMPLE_LIST} -b
