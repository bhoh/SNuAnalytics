...
class LeptonSFMaker(Module):
    ...
    def endJob(self):
        ...
        print "endJob, autosave is off. turn it on"
        self.out._tree.AutoSave("FlushBaskets")
        self.out._tree.SetAutoSave()
        print "self.out._tree.GetAutoSave()=",self.out._tree.GetAutoSave()
        pass
    ...
    def endFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        print "endFile, autosave is off. turn it on"
        self.out._tree.AutoSave("FlushBaskets")
        print "self.out._tree.GetAutoSave()=,",self.out._tree.GetAutoSave()
        pass
    ...
    def initReaders(self,tree): # this function gets the pointers to Value and ArrayReaders and sets them in the C++ worker class
        ...
        print "[jhchoi] start initReaders"
        cmssw_base = os.getenv('CMSSW_BASE')
        self.SF_dict = {}
