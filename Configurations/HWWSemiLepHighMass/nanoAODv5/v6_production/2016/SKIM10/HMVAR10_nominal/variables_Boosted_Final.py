...
variables['WtaggerFatjet_'+WTAG+'_nom_pt']={
    'name':'WtaggerFatjet_'+WTAG+'_nom_pt[lnJ_'+WTAG+'_widx]',
    'range':(100,0,1000),
...
variables['WtaggerFatjet_'+WTAG+'_nom_mass']={
    'name':'WtaggerFatjet_'+WTAG+'_nom_mass[lnJ_'+WTAG+'_widx]',
    'range':(42,40,250),
...
variables['WtaggerFatjet_'+WTAG+'_nom_tau21ddt']={
    'name':'WtaggerFatjet_'+WTAG+'_nom_tau21ddt[lnJ_'+WTAG+'_widx]',
    'range':(100,0,1),
