...
class dummy:
    def __init__(self):
        self.cutsFile=''
opt=dummy()
opt.cutsFile='cuts_Resolved_GGF_SB.py'
...
BoostedProdCats={}
if 'GGF' in opt.cutsFile : BoostedProdCats['BoostedGGF']='isBoost_'+WTAG+'_nom&&!isVBF_Boost_'+WTAG+'_nom'
if 'VBF' in opt.cutsFile : BoostedProdCats['BoostedVBF']='isBoost_'+WTAG+'_nom&&isVBF_Boost_'+WTAG+'_nom'



BoostedRegionCats={}
if 'SR' in opt.cutsFile:BoostedRegionCats['SR']='(nBJetBoost_'+WTAG+'_nom==0) && (isBoostSR_'+WTAG+'_nom)'
if 'TOP' in opt.cutsFile:BoostedRegionCats['TOP'] ='(nBJetBoost_'+WTAG+'_nom > 0) && (isBoost_'+WTAG+'_nom)'
if 'SB' in opt.cutsFile:BoostedRegionCats['SB']='(nBJetBoost_'+WTAG+'_nom==0) && (isBoostSB_'+WTAG+'_nom)'
