...
(python MakeRmsShape.py -c configuration_Boosted.py -f hadd.root -n pdfAccept;) &> RunMakeRms_Shape_configuration_Boosted.log&
(python MakeRmsShape.py -c configuration_Resolved.py -f hadd.root -n pdfAccept;) &> RunMakeRms_Shape_configuration_Resolved.log&
