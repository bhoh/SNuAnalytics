...
variables['nAddJetBoosted']={
    'name':'nAddJetBoosted',
    'range':(10,0,10),
    'xaxis':'nAddJetBoosted',
    'fold':0,
}
...
variables['ak4Jet_pt']={
    'name' : 'CleanJet_pt[AddJetBoosted_cjidx]',
    'range':(50,25,600),
    'xaxis':'ak4Jet_pt',
    'fold':0
...
variables['ak4Jet_eta']={
    'name' : 'CleanJet_eta[AddJetBoosted_cjidx]',
    'range':(50,-5,5),
    'xaxis':'ak4Jet_eta',
    'fold':0
...
variables[bAlgo]={
    'name' : 'Jet_btag'+bAlgo+'[CleanJet_jetIdx[AddJetBoosted_cjidx]]',
    'range':(25,0,1),
    'xaxis':bAlgo,
    'fold':0
