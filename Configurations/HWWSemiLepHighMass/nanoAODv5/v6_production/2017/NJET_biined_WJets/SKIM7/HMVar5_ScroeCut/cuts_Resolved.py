...
ScoreCats={}
ScoreCats['ALLScore']='1'
ScoreCats['Score0To40']='Whad_ScoreToLeast'+_ALGO+" < 40 "
ScoreCats['Score0To30']='Whad_ScoreToLeast'+_ALGO+" < 30 "
ScoreCats['Score40ToInf']='Whad_ScoreToLeast'+_ALGO+" > 40 "
                ...
                for WlepMtCut in ResolvedWlepMtCats:
                    for WWMtCut in ResolvedWWMtCats:
                        for ScoreCut in ScoreCats:
                            cuts[LepCut+'__'+ProdCut+'__'+RegionCut+'__'+PtOvMCut+'__'+WlepMtCut+'__'+WWMtCut+'__'+ScoreCut] = LepCats[LepCut]\
