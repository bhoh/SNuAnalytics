...
STEP="MCl1loose2017v6__MCCorr2017v6__HMSemilepSkimJHv6_7__HMlnjjVars_Dev_jhchoi5/"



CAMPAIGN_DATA='Run2017_102X_nAODv5_Full2017v6'
STEP_DATA="DATAl1loose2017v6__HMSemilepSkimJHv6_7_data__HMlnjjVars_Dev_jhchoi5/"
...
if DOPUCHECK:
  ...
  new_samples={}
  for this_s in samples:
    if this_s == "DATA":continue
    new_samples[this_s+'_FromPU']=deepcopy(samples[this_s])
    new_samples[this_s+'_FromPV']=deepcopy(samples[this_s])
    new_samples[this_s+'_FromPV']['weight']+="*!jjFromPU"
    new_samples[this_s+'_FromPU']['weight']+="*jjFromPU"
