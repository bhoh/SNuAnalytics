...
for flv in ${FLV[@]};do
    ...
    #(mkPlot.py --pycfg=configuration_Resolved.py --inputFile=${input} --plotFile=plot_${flv}.py --cutsFile=cuts_Resolved_${flv}.py --outputDirPlots=plots_2017_Resolved_${flv} --showIntegralLegend=1 &> Plot_maker_run_Resolved_${flv}.log;echo "DONE" >> Plot_maker_run_Resolved_${flv}.log)&
    #(mkPlot.py --pycfg=configuration_Resolved.py --inputFile=${input} --plotFile=plot_${flv}_SR.py --cutsFile=cuts_Resolved_${flv}_SR.py --outputDirPlots=plots_2017_Resolved_${flv} --showIntegralLegend=1 &> Plot_maker_run_Resolved_${flv}.log;echo "DONE" >> Plot_maker_run_Resolved_${flv}.log)&
    ((mkPlot.py --pycfg=configuration_Resolved.py --inputFile=${input} --plotFile=plot_${flv}.py --cutsFile=cuts_Resolved_${flv}.py --outputDirPlots=plots_2017_Resolved_${flv} --showIntegralLegend=1;mkPlot.py --pycfg=configuration_Resolved.py --inputFile=${input} --plotFile=plot_${flv}_SR.py --cutsFile=cuts_Resolved_${flv}_SR.py --outputDirPlots=plots_2017_Resolved_${flv} --showIntegralLegend=1)&> Plot_maker_run_Resolved_${flv}.log;echo "DONE" >> Plot_maker_run_Resolved_${flv}.log)&
done
EndTime=$(date +%s)
echo $EndTime
