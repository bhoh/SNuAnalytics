...
#for MX in [900]:
    ...
    if 'scale' in plot['ggHWWlnuqq_M'+str(MX)]:plot['ggHWWlnuqq_M'+str(MX)]['nameHR']=plot['ggHWWlnuqq_M'+str(MX)]['nameHR']+'_X'+str(plot['ggHWWlnuqq_M'+str(MX)]['scale'])
...
#for MX in [900]:
    ...
    if 'scale' in plot['ggHWWlnuqq_M'+str(MX)]:plot['ggHWWlnuqq_M'+str(MX)]['nameHR']=plot['vbfHWWlnuqq_M'+str(MX)]['nameHR']+'_X'+str(plot['vbfHWWlnuqq_M'+str(MX)]['scale'])
