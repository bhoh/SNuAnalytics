...
for name in [ 'DY', 'WZZ', 'WWZ','WWW','ZZZ', 'ZZ', 'WZ', 'WW', 'WpWmJJ_EWK_QCD_noHiggs', 'top', 'Wjets0j', 'Wjets1j', 'Wjets2j','vbfHWWlnuqq_M125','ggHWWlnuqq_M125'] + ['QCD_EM','QCD_bcToE']:
    structure[name]  = {
        'isSignal' : 0,
        'isData'   : 0
    }

#ggHWWlnuqq_M2000_S_B_I
structure['ggHWWlnuqq_M2000'] = {
    'isSignal' : 1,
    'isData'   : 0
}


structure['vbfHWWlnuqq_M2000'] = {
    'isSignal' : 1,
    'isData'   : 0
}
