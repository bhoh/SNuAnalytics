...
for flv in ${FLV[@]};do
    ...
    #(mkPlot.py --pycfg=configuration_Boosted.py --inputFile=${input} --plotFile=plot_${flv}.py --cutsFile=cuts_Boosted_${flv}.py --outputDirPlots=plots_2017_Boosted_${flv} --showIntegralLegend=1 &> Plot_maker_run_Boosted_${flv}.log;echo "DONE" >> Plot_maker_run_Boosted_${flv}.log)&
    #(mkPlot.py --pycfg=configuration_Boosted.py --inputFile=${input} --plotFile=plot_${flv}_SR.py --cutsFile=cuts_Boosted_${flv}_SR.py --outputDirPlots=plots_2017_Boosted_${flv} --showIntegralLegend=1 &> Plot_maker_run_Boosted_${flv}.log;echo "DONE" >> Plot_maker_run_Boosted_${flv}.log)&
    ((mkPlot.py --pycfg=configuration_Boosted.py --inputFile=${input} --plotFile=plot_${flv}.py --cutsFile=cuts_Boosted_${flv}.py --outputDirPlots=plots_2017_Boosted_${flv} --showIntegralLegend=1;mkPlot.py --pycfg=configuration_Boosted.py --inputFile=${input} --plotFile=plot_${flv}_SR.py --cutsFile=cuts_Boosted_${flv}_SR.py --outputDirPlots=plots_2017_Boosted_${flv} --showIntegralLegend=1) &> Plot_maker_run_Boosted_${flv}.log;echo "DONE" >> Plot_maker_run_Boosted_${flv}.log)&
done
EndTime=$(date +%s)
echo $EndTime
