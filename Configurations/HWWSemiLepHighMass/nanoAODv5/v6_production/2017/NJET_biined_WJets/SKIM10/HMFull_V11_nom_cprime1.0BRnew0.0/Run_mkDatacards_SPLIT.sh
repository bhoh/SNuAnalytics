...
for MX in ${ARR_MASS[@]};do
	...
	for rg in ${ListRegion[@]};do
		...
		echo ${input}
		mkDatacards.py --pycfg=configuration_Boosted_${proc}_${rg}.py --structureFile=MassPoints/structure_M${MX}_${flv}.py --cutsFile=cuts_Boosted_${proc}_${rg}_${flv}.py --inputFile=$input --outputDirDatacard=Datacards_${YEAR}/Datacard_M${MX} --samplesFile=MassPoints/samples_${YEAR}limit_M${MX}_${flv}.py --variablesFile=variables_Boosted_Final.py &> Run_mkDatacards_cuts_Boosted_${proc}_${rg}_${flv}.log&

		input=`ls rootFile*Resol*${proc}*${rg}/hadd.root`
		echo ${input}
		mkDatacards.py --pycfg=configuration_Resolved_${proc}_${rg}.py --structureFile=MassPoints/structure_M${MX}_${flv}.py --cutsFile=cuts_Resolved_${proc}_${rg}_${flv}.py --inputFile=$input --outputDirDatacard=Datacards_${YEAR}/Datacard_M${MX} --samplesFile=MassPoints/samples_${YEAR}limit_M${MX}_${flv}.py --variablesFile=variables_Resolved_Final.py &> Run_mkDatacards_cuts_Resolved_${proc}_${rg}_${flv}.log&
