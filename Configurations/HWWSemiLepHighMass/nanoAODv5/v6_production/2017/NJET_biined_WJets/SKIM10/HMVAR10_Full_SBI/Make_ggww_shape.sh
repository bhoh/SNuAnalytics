...
echo $ggWWfile
echo "hadd -f ${ggWWfile} ${haddlist}"
(python python_tool/latino/CombineShapesToAvg.py -c configuration_Resolved.py -f ${ggWWfile} -s ${listB} -n ggWW -o;cp ${ggWWfile}_ggWW ${rootfiledir}/plot_ggWW.root)&> Make_ggww_shape_Resolved.log&
