...
##--Boosted
(python MakeEnvelopShape.py -c configuration_Boosted.py  -f hadd.root -n QCDscaleAccept;python MakeSymhessianAsShape.py -c configuration_Boosted.py -f hadd.root -n pdfAccept;) &> RunMakeQCDscale_SymhessianAs_Shape_configuration_Boosted.log&
##--Resolved
(python MakeEnvelopShape.py -c configuration_Resolved.py  -f hadd.root -n QCDscaleAccept;python MakeSymhessianAsShape.py -c configuration_Resolved.py -f hadd.root -n pdfAccept;) &> RunMakeQCDscale_SymhessianAs_Shape_configuration_Resolved.log&
EndTime=$(date +%s)
echo $EndTime
