...
samples['ggHWWlnuqq_M165'] = { 'name'   :   getSampleFiles(directory,'GluGluHToWWToLNuQQ_M165',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
    

samples['vbfHWWlnuqq_M165'] = { 'name'   :   getSampleFiles(directory,'VBFHToWWToLNuQQ_M165',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
