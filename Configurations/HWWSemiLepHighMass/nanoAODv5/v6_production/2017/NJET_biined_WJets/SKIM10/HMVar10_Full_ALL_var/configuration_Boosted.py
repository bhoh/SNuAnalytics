...
#tag='simple2017'
tag='2017_Boosted_SKIM10_HMVar10_Fullvar___THIS_PROC_____THIS_REGION__'


variablesFile='variables_Boosted.py' ##what variables to draw
cutsFile='cuts_Boosted___THIS_PROC_____THIS_REGION__.py' ## event selection##region selection
