...
samples['ggHWWlnuqq_M155'] = { 'name'   :   getSampleFiles(directory,'GluGluHToWWToLNuQQ_M155',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
    

samples['vbfHWWlnuqq_M155'] = { 'name'   :   getSampleFiles(directory,'VBFHToWWToLNuQQ_M155',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
