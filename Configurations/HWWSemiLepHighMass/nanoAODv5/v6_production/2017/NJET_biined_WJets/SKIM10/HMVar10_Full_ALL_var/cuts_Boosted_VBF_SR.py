...
BoostedProdCats={}
if 'GGF' in scriptname : BoostedProdCats['BoostedGGF']='isBoost_'+WTAG+'_nom&&!isVBF_Boost_'+WTAG+'_nom'
if 'VBF' in scriptname : BoostedProdCats['BoostedVBF']='isBoost_'+WTAG+'_nom&&isVBF_Boost_'+WTAG+'_nom'



BoostedRegionCats={}
if 'SR' in scriptname:BoostedRegionCats['SR']='(nBJetBoost_'+WTAG+'_nom==0) && (isBoostSR_'+WTAG+'_nom)'
if 'TOP' in scriptname:BoostedRegionCats['TOP'] ='(nBJetBoost_'+WTAG+'_nom > 0) && (isBoost_'+WTAG+'_nom)'
if 'SB' in scriptname:BoostedRegionCats['SB']='(nBJetBoost_'+WTAG+'_nom==0) && (isBoostSB_'+WTAG+'_nom)'
