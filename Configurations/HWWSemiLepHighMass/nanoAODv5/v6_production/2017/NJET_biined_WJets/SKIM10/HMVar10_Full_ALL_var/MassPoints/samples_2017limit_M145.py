...
samples['ggHWWlnuqq_M145'] = { 'name'   :   getSampleFiles(directory,'GluGluHToWWToLNuQQ_M145',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
    

samples['vbfHWWlnuqq_M145'] = { 'name'   :   getSampleFiles(directory,'VBFHToWWToLNuQQ_M145',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
