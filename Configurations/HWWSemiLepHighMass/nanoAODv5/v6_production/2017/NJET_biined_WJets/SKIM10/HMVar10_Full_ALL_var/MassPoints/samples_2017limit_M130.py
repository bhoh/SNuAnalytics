...
samples['ggHWWlnuqq_M130'] = { 'name'   :   getSampleFiles(directory,'GluGluHToWWToLNuQQ_M130',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
    

samples['vbfHWWlnuqq_M130'] = { 'name'   :   getSampleFiles(directory,'VBFHToWWToLNuQQ_M130',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
