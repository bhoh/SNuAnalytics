...
for proc in ListProc:
    for rg in ListRegion:
        os.system('cp configuration_'+boosted+'.py '+'configuration_'+boosted+'_'+proc+'_'+rg+'.py')
        os.system('cp cuts_'+boosted+'.py '+'cuts_'+boosted+'_'+proc+'_'+rg+'.py')
        path='configuration_'+boosted+'_'+proc+'_'+rg+'.py'
