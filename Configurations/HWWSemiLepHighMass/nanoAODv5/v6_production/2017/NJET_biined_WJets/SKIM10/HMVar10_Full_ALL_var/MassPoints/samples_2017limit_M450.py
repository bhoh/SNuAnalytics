...
samples['ggHWWlnuqq_M450'] = { 'name'   :   getSampleFiles(directory,'GluGluHToWWToLNuQQ_M450',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
    

samples['vbfHWWlnuqq_M450'] = { 'name'   :   getSampleFiles(directory,'VBFHToWWToLNuQQ_M450',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
