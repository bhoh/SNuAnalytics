...
samples['ggHWWlnuqq_M350'] = { 'name'   :   getSampleFiles(directory,'GluGluHToWWToLNuQQ_M350',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
    

samples['vbfHWWlnuqq_M350'] = { 'name'   :   getSampleFiles(directory,'VBFHToWWToLNuQQ_M350',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
