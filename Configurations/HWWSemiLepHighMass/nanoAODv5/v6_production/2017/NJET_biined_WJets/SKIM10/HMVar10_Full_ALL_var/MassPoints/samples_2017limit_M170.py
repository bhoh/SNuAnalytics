...
samples['ggHWWlnuqq_M170'] = { 'name'   :   getSampleFiles(directory,'GluGluHToWWToLNuQQ_M170',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
    

samples['vbfHWWlnuqq_M170'] = { 'name'   :   getSampleFiles(directory,'VBFHToWWToLNuQQ_M170',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
