...
if 'GGF' in scriptname :ResolvedProdCats['ResolvedGGF']='isResol'+_ALGO_+'nom && !isVBF_Resol'+_ALGO_+'nom'
if 'VBF' in scriptname :ResolvedProdCats['ResolvedVBF']='isResol'+_ALGO_+'nom && isVBF_Resol'+_ALGO_+'nom'
    

ResolvedRegionCats={}
##--type in kin var module'_
if 'SR' in scriptname :ResolvedRegionCats['SR'] = '(nBJetResol'+_ALGO_+'nom == 0) && isResolSR'+_ALGO_+'nom'
if 'SB' in scriptname :ResolvedRegionCats['SB'] = '(nBJetResol'+_ALGO_+'nom == 0) && isResolSB'+_ALGO_+'nom'
if 'TOP' in scriptname :ResolvedRegionCats['TOP'] = '(nBJetResol'+_ALGO_+'nom > 0) && isResol'+_ALGO_+'nom'
