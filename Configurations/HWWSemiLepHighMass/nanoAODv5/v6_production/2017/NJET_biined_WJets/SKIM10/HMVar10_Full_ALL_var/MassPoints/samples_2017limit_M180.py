...
samples['ggHWWlnuqq_M180'] = { 'name'   :   getSampleFiles(directory,'GluGluHToWWToLNuQQ_M180',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
    

samples['vbfHWWlnuqq_M180'] = { 'name'   :   getSampleFiles(directory,'VBFHToWWToLNuQQ_M180',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
