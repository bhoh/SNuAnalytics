...
samples['ggHWWlnuqq_M115'] = { 'name'   :   getSampleFiles(directory,'GluGluHToWWToLNuQQ_M115',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
    

samples['vbfHWWlnuqq_M115'] = { 'name'   :   getSampleFiles(directory,'VBFHToWWToLNuQQ_M115',False,'nanoLatino_'),
                                                 'weight' : 'XSWeight*SFweight*METFilter_MC',
                                                 'FilesPerJob' : 10,
                                               }
