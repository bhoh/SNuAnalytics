...
os.system('python TurnOffCombinedSamples.py WPandCut2018.py CombineH125')
os.system('python TurnOffCombinedSamples.py WPandCut2018.py CombineMultiV')
os.system('python TurnOffCombinedSamples.py WPandCut2018.py CombineWjets')
os.system('python TurnOffCombinedSamples.py WPandCut2018.py Combine_ggWW')
os.system('python TurnOffCombinedSamples.py WPandCut2018.py Combine_qqWWqq')
os.system('python TurnOffCombinedSamples.py WPandCut2018.py CombineSBI')



samples={}
handle=open('samples_2018.py','r')
exec(handle)
handle.close()
