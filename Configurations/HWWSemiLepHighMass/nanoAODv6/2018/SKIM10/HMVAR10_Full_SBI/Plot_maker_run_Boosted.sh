...
#	    echo ${input}
#	    (mkPlot.py --pycfg=configuration_Boosted_${proc}_${rg}.py --inputFile=${input} --plotFile=plot_Boosted_${flv}_${rg}.py --cutsFile=cuts_Boosted_${proc}_${rg}_${flv}.py --outputDirPlots=plots_2018_Boosted_${proc}_${rg}_${flv} &> Plot_maker_run_Boosted_${proc}_${rg}_${flv}.log;echo "DONE" >> Plot_maker_run_Boosted_${proc}_${rg}_${flv}.log)&
#	done
#    done
#done
...
for flv in ${FLV[@]};do
    ...
    (mkPlot.py --pycfg=configuration_Boosted.py --inputFile=${input} --plotFile=plot_${flv}.py --cutsFile=cuts_Boosted_${flv}.py --outputDirPlots=plots_2018_Boosted_${flv} &> Plot_maker_run_Boosted_${flv}.log;echo "DONE" >> Plot_maker_run_Boosted_${flv}.log)&
done
EndTime=$(date +%s)
echo $EndTime
