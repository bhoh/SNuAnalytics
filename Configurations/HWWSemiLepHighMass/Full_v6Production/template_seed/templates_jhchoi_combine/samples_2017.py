...
for MX in List_MX_VBF:
  ...
  samples['vbfHWWlnuqq_M'+str(MX)+'_B'] = { 'name'   :   getSampleFiles(directory,'VBFHToWWToLNuQQ_M'+str(MX),False,'nanoLatino_'),
                                            # 'weight' : mcCommonWeight+'*'+model+'_B'+'*'+cut,
                                            'weight' : mcCommonWeight+'*WtaggerSFnom'+'*'+model+'_B'+'*'+normB+'*'+cut,
                                            'FilesPerJob' : FilesPerJob,
  }
...
addSampleWeight(samples, 'Wjets0j', 'WJetsToLNu-0J', 'MjjShape')
addSampleWeight(samples, 'Wjets1j', 'WJetsToLNu-1J', 'MjjShape')
addSampleWeight(samples, 'Wjets2j', 'WJetsToLNu-2J', 'MjjShape')
...
if MjjShapeStudy: ##Add Wjets slope shape
  ...
  addSampleWeight(samples, 'Wjets0j_slope', 'WJetsToLNu-0J', kfactor['Wjets0j'])
  addSampleWeight(samples, 'Wjets1j_slope', 'WJetsToLNu-1J', kfactor['Wjets1j'])
  addSampleWeight(samples, 'Wjets2j_slope', 'WJetsToLNu-2J', kfactor['Wjets2j'])

  addSampleWeight(samples, 'Wjets0j_slope', 'WJetsToLNu-0J', 'SlopeWeight')
  addSampleWeight(samples, 'Wjets1j_slope', 'WJetsToLNu-1J', 'SlopeWeight')
  addSampleWeight(samples, 'Wjets2j_slope', 'WJetsToLNu-2J', 'SlopeWeight')
...
if CombineWjets:
    ...
    for wjet in Wjets:
      samples['Wjets']['name']+=(samples[wjet]['name'])
      del samples[wjet]
    addSampleWeight(samples, 'Wjets', 'WJetsToLNu-0J', kfactor['Wjets0j'])
    addSampleWeight(samples, 'Wjets', 'WJetsToLNu-1J', kfactor['Wjets1j'])
    addSampleWeight(samples, 'Wjets', 'WJetsToLNu-2J', kfactor['Wjets2j'])
    addSampleWeight(samples, 'Wjets', 'WJetsToLNu-0J', 'MjjShape')
    addSampleWeight(samples, 'Wjets', 'WJetsToLNu-1J', 'MjjShape')
    addSampleWeight(samples, 'Wjets', 'WJetsToLNu-2J', 'MjjShape')
    
    if MjjShapeStudy:
      samples['Wjets_slope']   ={ 'name' : [],
                                  'weight' : mcCommonWeight,
                                  'FilesPerJob' : FilesPerJobMainBKG,
                                }
      for wjet in Wjets:
        samples['Wjets_slope']['name']+=(samples[wjet+'_slope']['name'])
        del samples[wjet+'_slope']
      addSampleWeight(samples, 'Wjets_slope', 'WJetsToLNu-0J', kfactor['Wjets0j'])
      addSampleWeight(samples, 'Wjets_slope', 'WJetsToLNu-1J', kfactor['Wjets1j'])
      addSampleWeight(samples, 'Wjets_slope', 'WJetsToLNu-2J', kfactor['Wjets2j'])
      addSampleWeight(samples, 'Wjets_slope', 'WJetsToLNu-0J', 'MjjShape')
      addSampleWeight(samples, 'Wjets_slope', 'WJetsToLNu-1J', 'MjjShape')
      addSampleWeight(samples, 'Wjets_slope', 'WJetsToLNu-2J', 'MjjShape')
...
samples['qqWWqq'] = {    'name'   :   getSampleFiles(directory,'WpToLNu_WmTo2J',False,'nanoLatino_')
...
if CombineMultiV  :
  ...
  for V in MultiV:
    samples['MultiV']['name']+=samples[V]['name']
    del samples[V]
...
if CombineHTT:
  ...
  for htt in HTT:
    samples['HTT']['name']+=samples[htt]['name']
    del samples[htt]
