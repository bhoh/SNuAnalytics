...
if CombineWjets:
  ...
  for wjet in Wjets:
    ...
    del samples[wjet]
  addSampleWeight(samples, 'Wjets', 'WJetsToLNu_0J', kfactor['Wjets0j'])
  addSampleWeight(samples, 'Wjets', 'WJetsToLNu_1J', kfactor['Wjets1j'])
  addSampleWeight(samples, 'Wjets', 'WJetsToLNu_2J', kfactor['Wjets2j'])
  addSampleWeight(samples, 'Wjets', 'WJetsToLNu_0J', 'MjjShape')
  addSampleWeight(samples, 'Wjets', 'WJetsToLNu_1J', 'MjjShape')
  addSampleWeight(samples, 'Wjets', 'WJetsToLNu_2J', 'MjjShape')
  ...
  if MjjShapeStudy:
    ...
    addSampleWeight(samples, 'Wjets_slope', 'WJetsToLNu_0J', kfactor['Wjets0j'])
    addSampleWeight(samples, 'Wjets_slope', 'WJetsToLNu_1J', kfactor['Wjets1j'])
    addSampleWeight(samples, 'Wjets_slope', 'WJetsToLNu_2J', kfactor['Wjets2j'])
    addSampleWeight(samples, 'Wjets_slope', 'WJetsToLNu_0J', 'MjjShape')
    addSampleWeight(samples, 'Wjets_slope', 'WJetsToLNu_1J', 'MjjShape')
    addSampleWeight(samples, 'Wjets_slope', 'WJetsToLNu_2J', 'MjjShape')
