...
for flv in ${ListFlavor[@]};do
	...
	for MX in ${ARR_MASS[@]};do
		...
		command="cd ${CURDIR};mkDatacards.py --pycfg=configuration_${bst}_${rg}.py --structureFile=MassPoints/structure_M${MX}_${flv}.py --cutsFile=cuts_${bst}_${rg}_${flv}.py --inputFile=$input --outputDirDatacard=Datacards_${YEAR}/Datacard_M${MX} --samplesFile=MassPoints/samples_limit_M${MX}_${flv}.py --variablesFile=variables_${bst}_${rg}.py"
