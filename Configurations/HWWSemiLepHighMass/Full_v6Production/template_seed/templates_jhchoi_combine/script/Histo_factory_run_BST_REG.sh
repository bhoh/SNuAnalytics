...
mkShapesMulti.py --pycfg=configuration_${BST}_${REG}.py --batchSplit=AsMuchAsPossible --doBatch --treeName Even
...
#mkShapesMulti.py --pycfg=configuration_Boosted_SR.py --batchSplit=AsMuchAsPossible --doBatch --treeName Events
