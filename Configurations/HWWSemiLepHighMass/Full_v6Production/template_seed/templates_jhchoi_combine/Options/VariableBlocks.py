VariableBlocks={}
VariableBlocks['LeptonMet']=['Lepton_eta[0]','Lepton_pt[0]','Lepton_eta[0]','Wlep_nom_mass','Wlep_nom_pt','Wlep_Mt','PuppiMET','PV_npvs']

VariableBlocks['Jet']=['nAK4Jet','nAK4Jet_eta4p7','LeadingJet_eta','LeadingJet_pt','LeadingJet_BtagScore','SubLeadingJet_pt','SubLeadingJet_BtagScore','SubLeadingJet_eta']
...
##
VariableBlocks['Final']=['Event','WW_mass']
