...
#LepWPweight ='event.Lepton_tightElectron_'+eleWP+'_IdIsoSF'+'[0]*\
#event.Lepton_tightMuon_'+muWP+'_IdIsoSF'+'[0]'
#LepWPweight='Lepton_tightElectron_'+eleWP+'_IdIsoSF'+'[0]*Lepton_tightMuon_'+muWP+'_IdIsoSF'+'[0]'
...
for Run in DataRun :
        directory = treeBaseDir+'Run2016_102X_nAODv4_Full2016v4/DATAl1loose2016'
