...
STEP="MCl1loose2016__MCCorr2016__FatJetPreselCleaning_semilep_v2__wlepMaker__whadJetSel"
...
STEP_DATA="DATAl1loose2016__FatJetPreselCleaning_semilep_v2__wlepMaker__whadJetSel"
...
bAlgo='DeepB'
bWP='0.2217'
#'( sqrt( pow(Jet_eta - PreselFatJet_eta[0],2) + pow(Jet_phi - PreselFatJet_phi[0],2)) > 0.8)'
nbjet='(Sum$(Jet_jetId>0 && Jet_pt>20 && fabs(Jet_eta) < 2.4 && '+'Jet_btag'+bAlgo+' > '+bWP+' &&  ( sqrt( pow(Jet_eta - PreselFatJet_eta[0],2) + pow(Jet_phi - PreselFatJet_phi[0],2)) > 0.8) ))'

#btagSF="( TMath::Exp(Sum$( TMath::Log( (Jet_pt>20 && Jet_pt<30 && abs(Jet_eta)<2.5)*Jet_btagSF_shape[Jet_jetIdx]+1*(Jet_pt<20 || Jet_pt>30 || abs(Jet_eta)>2.5) ) ) ) )"
btagSF='( TMath::Exp(Sum$( TMath::Log( (Jet_pt>20 && fabs(Jet_eta)<2.4 && ( sqrt( pow(Jet_eta - PreselFatJet_eta[0],2) + pow(Jet_phi - PreselFatJet_phi[0],2)) > 0.8) )*Jet_btagSF_shape+1*(Jet_pt<20 || abs(Jet_eta)>2.5 || ( sqrt( pow(Jet_eta - PreselFatJet_eta[0],2) + pow(Jet_phi - PreselFatJet_phi[0],2)) > 0.8) ) ) ) ) )'
