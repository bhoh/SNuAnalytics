...
#for histo factory
#mkShapes.py --pycfg=configuration_Simple.py --batchSplit=AsMuchAsPossible --doBatch --treeName Events
...
#for hadd
mkShapes.py --pycfg=configuration_Simple.py --batchSplit=AsMuchAsPossible --doHadd=True --treeName Events
