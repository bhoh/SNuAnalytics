...
fileName='rootFile_2017_SKIM7_QCD_ABCD_SF/hadd.root'
...
input_dict = {
  '' : {
    'input'    : 'rootFile_2017_SKIM7_QCD_ABCD_SF/hadd.root',
    'chennels' : {
      'sng_4j_D_eleCH_2b' : {
            ...
            #'nCleanJet20_2p5' : copy.deepcopy(samples),
            #'nCleanJet30_2p5' : copy.deepcopy(samples),
            #'nCleanJet20to30_2p5_PU_M' : copy.deepcopy(samples),
