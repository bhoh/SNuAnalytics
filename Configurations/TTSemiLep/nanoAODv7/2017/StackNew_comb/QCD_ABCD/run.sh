...
mkShapesMulti.py --pycfg=configuration_SF_final.py --batchSplit=AsMuchAsPossible --doBatch --treeName Events --outputDir=../../../../../../../../../../../../../cms_scratch/bhoh/rootFile_2017_SKIM7_QCD_ABCD_SF_final
