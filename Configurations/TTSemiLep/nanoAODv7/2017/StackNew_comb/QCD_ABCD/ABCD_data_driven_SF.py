...
fileName='rootFile_2017_SKIM7_QCD_ABCD/hadd.root'
...
nuisances = [
        ...
        'btag_hfUp',
        'btag_hfDown',
        'btag_hfstats1_2017Up',
        'btag_hfstats1_2017Down',
        'btag_hfstats2_2017Up',
        'btag_hfstats2_2017Down',
        'btag_lfstats1_2017Up',
        'btag_lfstats1_2017Down',
        'btag_lfstats2_2017Up',
        'btag_lfstats2_2017Down',
        'btag_cferr1Up',
        'btag_cferr1Down',
        'btag_cferr2Up',
        'btag_cferr2Down',
...
bins = {
   ...
   'sng_4j_eleCH_2b' : np.array([-2.5, -2.1, -1.48, -0.5, 0, 0.5, 1.48, 1.7, 2.1, 2.5]), # '1.7' is added to remove large stat bin 
...
def GetHisto(histoNameList, rebin, tag_key):
  histo_rebinned = None
...
for tag_key in input_dict:
  ...
  for ch in chennels:
    ...
    for var in chennels[ch]['B']:
      ...
      histoB = GetHisto(histoNameB, rebin, tag_key)
      histoC = GetHisto(histoNameC, rebin, tag_key)
