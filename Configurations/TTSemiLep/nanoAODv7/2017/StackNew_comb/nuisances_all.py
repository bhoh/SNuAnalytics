...
if regrouped_jec:
  ...
  for syst in jes_syst:
      ...
      nuisances[syst_] = {
          ...
          'samples': dict((skey, ['1.','1.']) for skey in mc),
          'folderUp'   : makeMCDirectory('_jetMETSyst_{SKIM}'.format(SKIM=skim_)) if not include_mva else makeMCDirectory_mva('_jetMETSyst_{SKIM}__mvaCHToCB_2017_jetMETSyst_{SKIM}'.format(SKIM=skim_))    ,
          'folderDown' : makeMCDirectory('_jetMETSyst_{SKIM}'.format(SKIM=skim_)) if not include_mva else makeMCDirectory_mva('_jetMETSyst_{SKIM}__mvaCHToCB_2017_jetMETSyst_{SKIM}'.format(SKIM=skim_)),
          'group': 'experimental',
  ...
  nuisances['jesTotal'] = {
      ...
      'samples': dict((skey, ['1.','1.']) for skey in mc),
      'folderUp'   : makeMCDirectory('_jetMETSyst_TotalUp')   if not include_mva else makeMCDirectory_mva('_jetMETSyst_TotalUp__mvaCHToCB_2017_jetMETSyst_TotalUp')    ,
      'folderDown' : makeMCDirectory('_jetMETSyst_TotalDown') if not include_mva else makeMCDirectory_mva('_jetMETSyst_TotalDown__mvaCHToCB_2017_jetMETSyst_TotalDown'),
