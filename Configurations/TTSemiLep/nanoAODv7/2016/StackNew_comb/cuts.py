...
supercut = '((nLooseLep == 1) && (nCleanJet30_2p4 >=3) && (nBJets_WP_M >= 2) && (MET_CHToCB_pt_nom > 20.))\
           || ((nLooseLep == 2) && (nCleanJet30_2p4 >=2) && (nBJets_WP_M >= 2) && (MET_CHToCB_pt_nom > 40.))'


#cuts['sng_4j_eleORmuCH_>=2b'] = {
#  'expr' : '(nLooseLep == 1) && (nCleanJet20_2p4_PU_M >=4) && (nCleanJet_custum == nCleanJet20_2p4_PU_M) && (nBJets_WP_M >= 2) && (eleCH || muCH)',
#}

cuts['sng_4j_eleORmuCH'] = {
  'expr' : '(nLooseLep == 1) && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)>=4) && (eleCH || muCH)',
  'categories' : {
...
cuts['sng_jbin'] = {
  'expr' : '(nLooseLep == 1) && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)>=4) && (eleCH || muCH)',
  'categories' : {
    'eleCH_4j_2b' : 'eleCH  && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)==4) && ((nBJets_WP_M + nBJets_WP_M_20to30) == 2)',
    'eleCH_5j_2b' : 'eleCH  && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)==5) && ((nBJets_WP_M + nBJets_WP_M_20to30) == 2)',
    'eleCH_6j_2b' : 'eleCH  && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)>=6) && ((nBJets_WP_M + nBJets_WP_M_20to30) == 2)',
    'muCH_4j_2b'  : 'muCH   && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)==4) && ((nBJets_WP_M + nBJets_WP_M_20to30) == 2)',
    'muCH_5j_2b'  : 'muCH   && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)==5) && ((nBJets_WP_M + nBJets_WP_M_20to30) == 2)',
    'muCH_6j_2b'  : 'muCH   && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)>=6) && ((nBJets_WP_M + nBJets_WP_M_20to30) == 2)',
    'eleCH_4j_3b' : 'eleCH  && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)==4) && ((nBJets_WP_M + nBJets_WP_M_20to30) == 3)',
    'eleCH_5j_3b' : 'eleCH  && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)==5) && ((nBJets_WP_M + nBJets_WP_M_20to30) == 3)',
    'eleCH_6j_3b' : 'eleCH  && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)>=6) && ((nBJets_WP_M + nBJets_WP_M_20to30) == 3)',
    'eleCH_4b'    : 'eleCH  && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)>=4) && ((nBJets_WP_M + nBJets_WP_M_20to30) >= 4)',
    'muCH_4j_3b'  : 'muCH   && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)==4) && ((nBJets_WP_M + nBJets_WP_M_20to30) == 3)',
    'muCH_5j_3b'  : 'muCH   && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)==5) && ((nBJets_WP_M + nBJets_WP_M_20to30) == 3)',
    'muCH_6j_3b'  : 'muCH   && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)>=6) && ((nBJets_WP_M + nBJets_WP_M_20to30) == 3)',
    'muCH_4b'     : 'muCH   && ((nCleanJet30_2p4+nCleanJet20to30_2p4_PU_M)>=4) && ((nBJets_WP_M + nBJets_WP_M_20to30) >= 4)',
  },
}


#cuts['dbl_2j_eeORmmORemORme_>=2b'] = {
#  'expr' : '(nLooseLep == 2) && (nCleanJet20_2p4_PU_M >=2) && (nBJets_WP_M >= 2) && (eeCH || mmCH || emCH || meCH)',
#}
...
#cuts['dbl_2j_>=2b'] = {
#  'expr' : '(nLooseLep == 2) && (nCleanJet20_2p4_PU_M >=2) && (nBJets_WP_M >= 2) && (eeCH || mmCH || emCH || meCH) && (mll > 12)',
#  'categories' : {
#    'ee' : 'eeCH',
#    'mm' : 'mmCH',
#    'em' : 'emCH',
...
cuts['dbl_4j_eeORmmORemORme'] = {
  'expr' : '(nLooseLep == 2) && (nCleanJet30_2p4>=2) && (nCleanJet20_2p4>=4) && (nBJets_WP_M >= 2) && (eeCH || mmCH || emCH || meCH) && (mll > 12)',
  'categories' : {
