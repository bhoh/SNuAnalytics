...
if include_bincl:
  cuts['sng_4j_eleORmuCH_bincl'] = {
    'expr' : '(nLooseLep == 1) && ((nCleanJet30_2p4)>=4) && (eleCH || muCH)',
  }
...
#  'expr' : '(nLooseLep == 1) && ((nCleanJet30_2p4)>=4) && (eleCH || muCH)',
#  'categories' : {
#    'eleCH_4j_2b' : 'eleCH  && ((nCleanJet30_2p4)==4) && ((nBJets_WP_M) == 2)',
#    'eleCH_5j_2b' : 'eleCH  && ((nCleanJet30_2p4)==5) && ((nBJets_WP_M) == 2)',
#    'eleCH_6j_2b' : 'eleCH  && ((nCleanJet30_2p4)>=6) && ((nBJets_WP_M) == 2)',
#    'muCH_4j_2b'  : 'muCH   && ((nCleanJet30_2p4)==4) && ((nBJets_WP_M) == 2)',
#    'muCH_5j_2b'  : 'muCH   && ((nCleanJet30_2p4)==5) && ((nBJets_WP_M) == 2)',
#    'muCH_6j_2b'  : 'muCH   && ((nCleanJet30_2p4)>=6) && ((nBJets_WP_M) == 2)',
#    'eleCH_4j_3b' : 'eleCH  && ((nCleanJet30_2p4)==4) && ((nBJets_WP_M) == 3)',
#    'eleCH_5j_3b' : 'eleCH  && ((nCleanJet30_2p4)==5) && ((nBJets_WP_M) == 3)',
#    'eleCH_6j_3b' : 'eleCH  && ((nCleanJet30_2p4)>=6) && ((nBJets_WP_M) == 3)',
#    'eleCH_4b'    : 'eleCH  && ((nCleanJet30_2p4)>=4) && ((nBJets_WP_M) >= 4)',
#    'muCH_4j_3b'  : 'muCH   && ((nCleanJet30_2p4)==4) && ((nBJets_WP_M) == 3)',
#    'muCH_5j_3b'  : 'muCH   && ((nCleanJet30_2p4)==5) && ((nBJets_WP_M) == 3)',
#    'muCH_6j_3b'  : 'muCH   && ((nCleanJet30_2p4)>=6) && ((nBJets_WP_M) == 3)',
#    'muCH_4b'     : 'muCH   && ((nCleanJet30_2p4)>=4) && ((nBJets_WP_M) >= 4)',
#  },
#}
#
#if include_bincl:
...
#    'expr' : '(nLooseLep == 1) && ((nCleanJet30_2p4)>=4) && (eleCH || muCH)',
#    'categories' : {
#      'eleCH_4j_2b' : 'eleCH  && ((nCleanJet30_2p4)==4)',
#      'eleCH_5j_2b' : 'eleCH  && ((nCleanJet30_2p4)==5)',
#      'eleCH_6j_2b' : 'eleCH  && ((nCleanJet30_2p4)>=6)',
#      'muCH_4j_2b'  : 'muCH   && ((nCleanJet30_2p4)==4)',
#      'muCH_5j_2b'  : 'muCH   && ((nCleanJet30_2p4)==5)',
#      'muCH_6j_2b'  : 'muCH   && ((nCleanJet30_2p4)>=6)',
#    },
#  }
