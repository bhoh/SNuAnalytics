...
#InputFile='QCD_ABCD/rootFile_2016_SKIM7_QCD_ABCD_SF/hadd_data_driven.root'
mkPlot.py --pycfg=configuration_final.py --inputFile=$InputFile --onlyPlot=cratio --scaleToPlot=1.7 --fileFormats=png,pdf
