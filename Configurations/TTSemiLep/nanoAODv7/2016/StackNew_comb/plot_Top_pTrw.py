...
groupPlot['TT+jj']  = {
                  ...
                  'isData'   : 0,                 
                  'samples'  : ['TTLJ_jj_Top_pTreweightUp','TTLL_jj_Top_pTreweightUp']
              }
...
groupPlot['TT+bb']  = {
                  ...
                  'isData'   : 0,                 
                  'samples'  : ['TTLJ_bb_Top_pTreweightUp','TTLJ_bj_Top_pTreweightUp','TTLL_bb_Top_pTreweightUp','TTLL_bj_Top_pTreweightUp']
              }
...
groupPlot['TT+cc']  = {
                  ...
                  'isData'   : 0,                 
                  'samples'  : ['TTLJ_cc_Top_pTreweightUp','TTLL_cc_Top_pTreweightUp']
              }
...
plot['TTLJ_jj_Top_pTreweightUp']  = {
                  'nameHR' : 'TTLJ+jj',
                  'isSignal' : 0,
                  'color': dict_TColor['orange'],
                  'isData'   : 0,                 
                  'samples'  : ['TTLJ_jj_Top_pTreweightUp']
              }

plot['TTLJ_cc_Top_pTreweightUp']  = {
                  'nameHR' : 'TTLJ+cc',
                  'isSignal' : 0,
                  'color': dict_TColor['red']+4,
                  'isData'   : 0,                 
                  'samples'  : ['TTLJ_cc_Top_pTreweightUp']
              }

plot['TTLJ_bj_Top_pTreweightUp']  = {
                  'nameHR' : 'TTLJ+bj',
                  'isSignal' : 0,
                  'color': dict_TColor['red']+1,
                  'isData'   : 0,                 
                  'samples'  : ['TTLJ_bj_Top_pTreweightUp']
              }

plot['TTLJ_bb_Top_pTreweightUp']  = {
                  'nameHR' : 'TTLJ+bb',
                  'isSignal' : 0,
                  'color': dict_TColor['blue'],
                  'isData'   : 0,                 
                  'samples'  : ['TTLJ_bb_Top_pTreweightUp']
              }

plot['TTLL_jj_Top_pTreweightUp']  = {
                  'nameHR' : 'TTLL+jj',
                  'isSignal' : 0,
                  'color': dict_TColor['orange'],
                  'isData'   : 0,                 
                  'samples'  : ['TTLL_jj_Top_pTreweightUp']
              }

plot['TTLL_cc_Top_pTreweightUp']  = {
                  'nameHR' : 'TTLL+cc',
                  'isSignal' : 0,
                  'color': dict_TColor['red']+4,
                  'isData'   : 0,                 
                  'samples'  : ['TTLL_cc_Top_pTreweightUp']
              }

plot['TTLL_bj_Top_pTreweightUp']  = {
                  'nameHR' : 'TTLL+bj',
                  'isSignal' : 0,
                  'color': dict_TColor['red']+1,
                  'isData'   : 0,                 
                  'samples'  : ['TTLL_bj_Top_pTreweightUp']
              }

plot['TTLL_bb_Top_pTreweightUp']  = {
                  'nameHR' : 'TTLL+bb',
                  'isSignal' : 0,
                  'color': dict_TColor['blue'],
                  'isData'   : 0,                 
                  'samples'  : ['TTLL_bb_Top_pTreweightUp']
              }
