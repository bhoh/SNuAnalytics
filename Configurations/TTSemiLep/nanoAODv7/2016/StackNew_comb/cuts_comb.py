...
cuts['dbl_2j'] = {
  ...
  'categories' : {
    'ee_2b' : 'eeCH && isOSpair && ((nBJets_WP_M + nBJets_WP_M_20to30) == 2)',
    'mm_2b' : 'mmCH && isOSpair && ((nBJets_WP_M + nBJets_WP_M_20to30) == 2)',
    'em_2b' : 'emCH && isOSpair && ((nBJets_WP_M + nBJets_WP_M_20to30) == 2)',
    'me_2b' : 'meCH && isOSpair && ((nBJets_WP_M + nBJets_WP_M_20to30) == 2)',
    'ee_3b' : 'eeCH && isOSpair && ((nBJets_WP_M + nBJets_WP_M_20to30) >= 3)',
    'mm_3b' : 'mmCH && isOSpair && ((nBJets_WP_M + nBJets_WP_M_20to30) >= 3)',
