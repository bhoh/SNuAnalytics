...
if include_mva:
  ...
  STEP='CHToCBLepton2018v9__CHToCBJetMETCorr2018v9'
...
if include_mva:
  ...
  STEP_DATA='DATACHToCBLepton2018v9__CHToCBJetMETCorr_data'
...
LepWPweight='((nLooseLep==1)*(%s + %s)+(nLooseLep==2)*(HLT_Ele32_WPTight_Gsf==1 || HLT_IsoMu24==1)*Alt$(OTF_SingleTrig_DATA_Eff[0]/OTF_SingleTrig_MC_Eff[0],1)*Lepton_RecoSF[0]*Alt$(Lepton_RecoSF[1],0)*LepSF2l__ele_%s__mu_%s)'%(eleWPweight,muWPweight,eleWP,muWP)
XSWeight      = 'XSWeight'
