...
if include_mva:
  STEP='CHToCBLepton2018v9__CHToCBJetMETCorr2018v9__kinFitTTSemiLepV5__mvaCHToCB_2018'
else:
  STEP='CHToCBLepton2018v9__CHToCBJetMETCorr2018v9__kinFitTTSemiLepV5_noRegCorr'

CAMPAIGN_DATA='Run2018_UL2018_nAODv9_Full2018v9'
#STEP_DATA='DATAl1loose2018v7__CHToCBJetMETCorr_data__kinFitTTSemiLep_2018'
if include_mva:
  STEP_DATA='DATACHToCBLepton2018v9__CHToCBJetMETCorr_data__kinFitTTSemiLepV5__mvaCHToCB_2018'
else:
  STEP_DATA='DATACHToCBLepton2018v9__CHToCBJetMETCorr_data__kinFitTTSemiLepV5_noRegCorr'
...
LepWPCut="((Sum$(Lepton_isTightElectron_{ELE_WP} && Lepton_triggmatched )>0.5 && {SNG_ELE_TRIG}>0.5) || (Sum$(Lepton_isTightMuon_{MU_WP} && Lepton_triggmatched )>0.5 && {SNG_MU_TRIG}>0.5))".format(ELE_WP=eleWP, MU_WP=muWP, SNG_ELE_TRIG='HLT_Ele32_WPTight_Gsf', SNG_MU_TRIG='HLT_IsoMu24')
...
#SFweight=SFweight+'*OTF_btagSF*HEMweight'
...
DataTrig = {
            ...
            'EGamma'         : '!HLT_IsoMu24 && HLT_Ele32_WPTight_Gsf',
           }

#DataTrig = {
#    'MuonEG'         : 'dblCH && Trigger_ElMu',
#    # include events firing both single electron and muon trigger
#    'SingleMuon'     : '(dblCH && !Trigger_ElMu && Trigger_sngMu) || (sngCH && Trigger_sngMu && ((muCH && !Trigger_sngEl) || (eleCH && Trigger_sngEl)))',
#    'EGamma' : '(dblCH && !Trigger_ElMu && !Trigger_sngMu && (Trigger_sngEl || Trigger_dblEl)) || (sngCH && Trigger_sngEl && ((muCH && Trigger_sngMu)  || (eleCH && !Trigger_sngMu)))',
#    #
#    # exclude events firing both single electron and muon trigger
#    #'SingleMuon'     : '(dblCH && !Trigger_ElMu && Trigger_sngMu) || (sngCH && muCH && Trigger_sngMu && !Trigger_sngEl)',
#    #'SingleElectron' : '(dblCH && !Trigger_ElMu && !Trigger_sngMu && Trigger_sngEl) || (sngCH && eleCH && Trigger_sngEl && !Trigger_sngMu)',
#    'DoubleMuon'     : 'dblCH && !Trigger_ElMu && !Trigger_sngMu && !Trigger_sngEl && !Trigger_dblEl && Trigger_dblMu',
#}
