...
CMD_TO_RUN_nonTT='(cd '$TARGET_PATH') && (hadd -j 10 -d /cms_scratch/bhoh hadd_nonTT.root '$TARGET_PATH'/*ST*.root '$TARGET_PATH'/*QCD*.root '$TARGET_PATH'/*DY*.root '$TARGET_PATH'/*Wjets*.root '$TARGET_PATH'/*TTWjets*.root '$TARGET_PATH'/*TTZjets*.root '$TARGET_PATH'/*ttH*.root '$TARGET_PATH'/*ZZ*.root '$TARGET_PATH'/*WZ*.root '$TARGET_PATH'/*WW*.root)'
#WORK_DIR='hadd_batch'
#JOB_NAME='hadd_TTLL'
...
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_DATA0"   -d 'hadd_DATA0'   -n hadd_DATA0_2017 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_DATA1"   -d 'hadd_DATA1'   -n hadd_DATA1_2017 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_TTLL0"   -d 'hadd_TTLL0'   -n hadd_TTLL0_2017 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_TTLL1"   -d 'hadd_TTLL1'   -n hadd_TTLL1_2017 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_TTLL2"   -d 'hadd_TTLL2'   -n hadd_TTLL2_2017 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_TTLJ0"   -d 'hadd_TTLJ0'   -n hadd_TTLJ0_2017 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_TTLJ1"   -d 'hadd_TTLJ1'   -n hadd_TTLJ1_2017 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_TTLJ2"   -d 'hadd_TTLJ2'   -n hadd_TTLJ2_2017 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_CHToCB0" -d 'hadd_CHToCB0' -n hadd_CHToCB0_2017 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_CHToCB1" -d 'hadd_CHToCB1' -n hadd_CHToCB1_2017 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_CHToCB2" -d 'hadd_CHToCB2' -n hadd_CHToCB2_2017 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_nonTT"   -d 'hadd_nonTT'  -n hadd_nonTT_2017 -m 10 -s
