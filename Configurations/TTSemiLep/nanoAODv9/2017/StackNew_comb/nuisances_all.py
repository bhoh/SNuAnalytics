...
RegCorr_branches = unclustEn_branches
...
if True:
  ...
  for syst in jes_syst:
      ...
      nuisances[syst_] = {
          ...
          'samples': dict((skey, ['1.','1.']) for skey in mc),
          'folderUp'   : makeMCDirectory('_jetMETSyst_{SKIM}Up'.format(SKIM=skim_)) if not include_mva else makeMCDirectory_mva('_jetMETSyst_{SKIM}Up__mvaCHToCB_2017_jetMETSyst_{SKIM}Up'.format(SKIM=skim_))    ,
          'folderDown' : makeMCDirectory('_jetMETSyst_{SKIM}Down'.format(SKIM=skim_)) if not include_mva else makeMCDirectory_mva('_jetMETSyst_{SKIM}Down__mvaCHToCB_2017_jetMETSyst_{SKIM}Down'.format(SKIM=skim_)),
          'group': 'experimental',
...
nuisances['jer'] = {
    ...
    'samples': dict((skey, ['1.','1.']) for skey in mc),
    'folderUp'   : makeMCDirectory('_jetMETSyst_jerUp')   if not include_mva else  makeMCDirectory_mva('_jetMETSyst_jerUp__mvaCHToCB_2017_jetMETSyst_jerUp')    ,
    'folderDown' : makeMCDirectory('_jetMETSyst_jerDown') if not include_mva else  makeMCDirectory_mva('_jetMETSyst_jerDown__mvaCHToCB_2017_jetMETSyst_jerDown'),
...
nuisances['unclustEn'] = {
    ...
    'samples': dict((skey, ['1.','1.']) for skey in mc),
    'folderUp'   : makeMCDirectory('_jetMETSyst_unclustEnUp')    if not include_mva else  makeMCDirectory_mva('_jetMETSyst_unclustEnUp__mvaCHToCB_2017_jetMETSyst_unclustEnUp')      ,
    'folderDown' : makeMCDirectory('_jetMETSyst_unclustEnDown')  if not include_mva else  makeMCDirectory_mva('_jetMETSyst_unclustEnDown__mvaCHToCB_2017_jetMETSyst_unclustEnDown')  ,
...
#    'samples': dict((skey, ['1.','1.']) for skey in mc),
#    'folderUp'   : makeMCDirectory('_jetMETSyst_bRegResUp')    if not include_mva else  makeMCDirectory_mva('_jetMETSyst_bRegResUp__mvaCHToCB_2017_jetMETSyst_bRegResUp')      ,
...
#    'samples': dict((skey, ['1.','1.']) for skey in mc),
#    'folderUp'   : makeMCDirectory('_jetMETSyst_cRegResUp')    if not include_mva else  makeMCDirectory_mva('_jetMETSyst_cRegResUp__mvaCHToCB_2017_jetMETSyst_cRegResUp')      ,
#    'folderDown' : makeMCDirectory('_jetMETSyst_cRegResDown')  if not include_mva else  makeMCDirectory_mva('_jetMETSyst_cRegResDown__mvaCHToCB_2017_jetMETSyst_cRegResDown')  ,
#    'group': 'experimental',
#}
...
if not splitISRscale_tt:
  nuisances['ISR_ttbar'] = {
      ...
      'type': 'shape',
      #'syncronize_stat' : True,
      'samples': dict((skey, isr_syst) for skey in ttmc_syst),
      'group': 'theory',
...
lhe_scale_syst_ttlj_4j = ['(nCleanJet20_2p4>=4)*(1.1079)+(nCleanJet20_2p4<4)','(nCleanJet20_2p4>=4)*(0.8886)+(nCleanJet20_2p4<4)']
lhe_scale_syst_ttlj_5j = ['(nCleanJet20_2p4>=5)*(1.0126)+(nCleanJet20_2p4<5)','(nCleanJet20_2p4>=5)*(0.9913)+(nCleanJet20_2p4<5)']
lhe_scale_syst_ttlj_6j = ['(nCleanJet20_2p4>=6)*(1.0234)+(nCleanJet20_2p4<6)','(nCleanJet20_2p4>=6)*(0.9841)+(nCleanJet20_2p4<6)']

lhe_scale_syst_ttll_4j = ['(nCleanJet20_2p4>=2)*(1.1079)+(nCleanJet20_2p4<2)','(nCleanJet20_2p4>=2)*(0.8886)+(nCleanJet20_2p4<2)']
lhe_scale_syst_ttll_5j = ['(nCleanJet20_2p4>=3)*(1.0126)+(nCleanJet20_2p4<3)','(nCleanJet20_2p4>=3)*(0.9913)+(nCleanJet20_2p4<3)']
lhe_scale_syst_ttll_6j = ['(nCleanJet20_2p4>=4)*(1.1519/1.1079/1.0126)+(nCleanJet20_2p4<4)','(nCleanJet20_2p4>=4)*(0.8647/0.8886/0.9913)+(nCleanJet20_2p4<4)']

lhe_scale_syst_chtocb_4j  = ['(nCleanJet20_2p4>=4)*(1.2843)+(nCleanJet20_2p4<4)','(nCleanJet20_2p4>=4)*(0.7925)+(nCleanJet20_2p4<4)']
lhe_scale_syst_chtocb_5j  = ['(nCleanJet20_2p4>=5)*(1.0041)+(nCleanJet20_2p4<5)','(nCleanJet20_2p4>=5)*(0.9960)+(nCleanJet20_2p4<5)']
lhe_scale_syst_chtocb_6j  = ['(nCleanJet20_2p4>=6)*(1.0055)+(nCleanJet20_2p4<6)','(nCleanJet20_2p4>=6)*(0.9950)+(nCleanJet20_2p4<6)']
...
#lhe_pdf_weight_syst = lambda skey : lhe_pdf_weight_syst_33 if 'ST' != skey and 'ttH' != skey else lhe_pdf_weight_syst_100
