...
supercut = '((nLooseLep == 1) && (nCleanJet25_2p4 >=4) && (nBJets_WP_M >= 2) && (MET_CHToCB_pt_nom >= 0.) && (status_nom==0))\
...
cuts['dbl_4j_eeORmmORemORme'] = {
  'expr' : '(nLooseLep == 2) && (nCleanJet25_2p4>=4) && (nBJets_WP_M + nBJets_WP_M_25to30 >= 2) && (eeCH || mmCH || emCH || meCH) && (mll > 12)',
  'categories' : {
