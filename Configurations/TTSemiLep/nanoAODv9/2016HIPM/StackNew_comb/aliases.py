...
aliases['nBJets_WP_M'] = {
            'expr': 'Sum$(Jet_pt_nom[CleanJet_jetIdx] > 30. && abs(CleanJet_eta) < 2.4 && Jet_btagDeepFlavB[CleanJet_jetIdx] > 0.2598 )'
            }

aliases['nBJets_WP_M_25to30'] = {
            'expr': 'Sum$(Jet_pt_nom[CleanJet_jetIdx] > 25. && Jet_pt_nom[CleanJet_jetIdx] <= 30. && abs(CleanJet_eta) < 2.4 && Jet_btagDeepFlavB[CleanJet_jetIdx] > 0.2598 )'
            }
...
btagSFNorm_top_1l = '(nCleanJet25_2p4<4)*(1.) + (nCleanJet25_2p4==4)*(0.903487961263) + (nCleanJet25_2p4==5)*(0.862775313038) + (nCleanJet25_2p4==6)*(0.818740670384) + (nCleanJet25_2p4==7)*(0.773510974258) + (nCleanJet25_2p4==8)*(0.727078073773) + (nCleanJet25_2p4>=9)*(0.681306892495)'
btagSFNorm_top_2l = '(nCleanJet25_2p4<4)*(1.) + (nCleanJet25_2p4==4)*(0.88037907678) + (nCleanJet25_2p4==5)*(0.835905625161) + (nCleanJet25_2p4==6)*(0.790230290978) + (nCleanJet25_2p4==7)*(0.74416511057) + (nCleanJet25_2p4==8)*(0.702100349303) + (nCleanJet25_2p4>=9)*(0.662077227088)'
...
EleTrigEffSFSource = '%s/src/SNuAnalytics/Configurations/TTSemiLep/patches/scale_factors/egammaEffi_Vcb_trig_2016_HIPM.root' % os.getenv('CMSSW_BASE')
MuTrigEffSFSource = '%s/src/SNuAnalytics/Configurations/TTSemiLep/patches/scale_factors/Efficiencies_muon_generalTracks_Z_Run2016_UL_HIPM_SingleMuonTriggers.root' % os.getenv('CMSSW_BASE')
### lepton eff.
...
aliases['Jet_PUID_SF_L'] = {
    ...
    'args': (PUIDSFSource,"UL2016APV","loose"),
    'samples': mc
}
...
#aliases['cutflow0'] = {
#     'expr': 'nCleanJet25_2p4==4',
#}
#
#aliases['cutflow1'] = {
#     'expr': 'nCleanJet25_2p4==5',
#}
#
#aliases['cutflow2'] = {
#     'expr': 'nCleanJet25_2p4==6',
#}
##XXX
#aliases['cutflows'] = {
#    'linesToAdd': [
#        '.L %s/patches/cutflow.cc+' % configurations
#    ],
#    'class': 'Cutflow',
#    'args': ('cutflow0','cutflow1','cutflow2'),
#}
