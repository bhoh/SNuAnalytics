...
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_DATA0"   -d 'hadd_DATA0'   -n hadd_DATA0_2016 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_DATA1"   -d 'hadd_DATA1'   -n hadd_DATA1_2016 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_TTLL0"   -d 'hadd_TTLL0'   -n hadd_TTLL0_2016 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_TTLL1"   -d 'hadd_TTLL1'   -n hadd_TTLL1_2016 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_TTLL2"   -d 'hadd_TTLL2'   -n hadd_TTLL2_2016 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_TTLJ0"   -d 'hadd_TTLJ0'   -n hadd_TTLJ0_2016 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_TTLJ1"   -d 'hadd_TTLJ1'   -n hadd_TTLJ1_2016 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_TTLJ2"   -d 'hadd_TTLJ2'   -n hadd_TTLJ2_2016 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_CHToCB0" -d 'hadd_CHToCB0' -n hadd_CHToCB0_2016 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_CHToCB1" -d 'hadd_CHToCB1' -n hadd_CHToCB1_2016 -m 10 -s
python $PYTHON_TOOL_PATH -c "$CMD_TO_RUN_CHToCB2" -d 'hadd_CHToCB2' -n hadd_CHToCB2_2016 -m 10 -s
