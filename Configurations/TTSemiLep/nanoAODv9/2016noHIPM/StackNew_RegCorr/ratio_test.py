...
f1  = ROOT.TFile("rootFile_2016noHIPM_SKIM9_RegCorr/hadd.root", "READ")
f2 = ROOT.TFile("../StackNew_comb/rootFile_2016noHIPM_SKIM9_final/hadd.root", "READ")
...
def drawGraph(canvas, x_name, legend1, legend2, legend3, ratio1, ratio2, ratio3, histo1, histo2, histo3):
  ...
  canvas.Modified()
  canvas.Update()
  canvas.Print("bc_corr_ratio_test_2016noHIPM.pdf")
...
if __name__ == "__main__":
  ...
  c1.Print("bc_corr_ratio_test_2016noHIPM.pdf[")
  ...
  drawGraph(c1, "M_{jj}", "b corr.", "jerUp", "jerDown", *calcRatio(baseDir_jer_fitted_dijet_M1, baseDir_jer_fitted_dijet_M2, baseDir_jer_fitted_dijet_M3, [None, "jer_2016Up", "jer_2016Down"]))
  #
  c1.Print("bc_corr_ratio_test_2016noHIPM.pdf]")
