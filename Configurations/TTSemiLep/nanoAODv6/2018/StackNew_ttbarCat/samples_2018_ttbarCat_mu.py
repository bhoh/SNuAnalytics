...
try:
  ...
  BASE_PATH = CMSSW + "/src/SNuAnalytics/Configurations/TTSemiLep/nanoAODv6/2018/StackNew"
...
name_TTLJ_hdampUp = getSampleFiles(directory_syst,'TTToSemiLeptonic_hdampUp',False,'nanoLatino_')
name_TTLJ_hdampDown = getSampleFiles(directory_syst,'TTToSemiLeptonic_hdampDown',False,'nanoLatino_')
name_TTLJ_mtopUp = getSampleFiles(directory_syst,'TTToSemiLeptonic_mtopUp',False,'nanoLatino_')
name_TTLJ_mtopDown = getSampleFiles(directory_syst,'TTToSemiLeptonic_mtopDown',False,'nanoLatino_')
...
name_TTLL_hdampUp = getSampleFiles(directory_syst,'TTTo2L2Nu_hdampUp',False,'nanoLatino_')
name_TTLL_hdampDown = getSampleFiles(directory_syst,'TTTo2L2Nu_hdampDown',False,'nanoLatino_')
name_TTLL_mtopUp = getSampleFiles(directory_syst,'TTTo2L2Nu_mtopUp',False,'nanoLatino_')
name_TTLL_mtopDown = getSampleFiles(directory_syst,'TTTo2L2Nu_mtopDown',False,'nanoLatino_')
