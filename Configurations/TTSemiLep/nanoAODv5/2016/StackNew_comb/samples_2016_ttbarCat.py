...
STEP="MCl1loose2016v6__MCCorr2016v6__HMSemilepSKIMv6_10__kinFitTTSemiLep_2016"



CAMPAIGN_DATA='Run2016_102X_nAODv5_Full2016v6'
STEP_DATA="DATAl1loose2016v6__HMSemilepSKIMv6_10_data__kinFitTTSemiLep_2016"
...
name_TTLJ_TuneCUETP8M2T4Up = getSampleFiles(directory,'TT_TuneCUETP8M2T4Up',False,'nanoLatino_')
name_TTLJ_TuneCUETP8M2T4Down = getSampleFiles(directory,'TT_TuneCUETP8M2T4Down',False,'nanoLatino_')
name_TTLJ_hdampUp = getSampleFiles(directory,'TT_hdampUp',False,'nanoLatino_')
name_TTLJ_hdampDown = getSampleFiles(directory,'TT_hdampDown',False,'nanoLatino_')
name_TTLJ_mtopUp = getSampleFiles(directory,'TT_mtopUp',False,'nanoLatino_')
name_TTLJ_mtopDown = getSampleFiles(directory,'TT_mtopDown',False,'nanoLatino_')
...
name_TTLL_TuneCUETP8M2T4Up = getSampleFiles(directory,'TT_TuneCUETP8M2T4Up',False,'nanoLatino_')
name_TTLL_TuneCUETP8M2T4Down = getSampleFiles(directory,'TT_TuneCUETP8M2T4Down',False,'nanoLatino_')
name_TTLL_hdampUp = getSampleFiles(directory,'TT_hdampUp',False,'nanoLatino_')
name_TTLL_hdampDown = getSampleFiles(directory,'TT_hdampDown',False,'nanoLatino_')
name_TTLL_mtopUp = getSampleFiles(directory,'TT_mtopUp',False,'nanoLatino_')
name_TTLL_mtopDown = getSampleFiles(directory,'TT_mtopDown',False,'nanoLatino_')
