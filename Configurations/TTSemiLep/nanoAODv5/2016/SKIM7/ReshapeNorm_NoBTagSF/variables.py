...
variables['b_pt20to30_abseta0to2.4']={
    'name' : 'CleanJet_pt > 20. && CleanJet_pt<=30 && abs(CleanJet_eta)<2.4 && Jet_hadronFlavour[CleanJet_jetIdx]==5',
    'range':(2,0,2),
    'xaxis':'Bin',
    'fold':0

}
variables['b_pt30to50_abseta0to2.4']={
    'name' : 'CleanJet_pt > 30. && CleanJet_pt<= 50. && abs(CleanJet_eta)<2.4 && Jet_hadronFlavour[CleanJet_jetIdx]==5',
    'range':(2,0,2),
    'xaxis':'Bin',
    'fold':0

}
variables['b_pt50to70_abseta0to2.4']={
    'name' : 'CleanJet_pt > 50. && CleanJet_pt<= 70. && abs(CleanJet_eta)<2.4 && Jet_hadronFlavour[CleanJet_jetIdx]==5',
    'range':(2,0,2),
    'xaxis':'Bin',
    'fold':0

}
variables['b_pt70to100_abseta0to2.4']={
    'name' : 'CleanJet_pt > 70. && CleanJet_pt<=100. && abs(CleanJet_eta)<2.4 && Jet_hadronFlavour[CleanJet_jetIdx]==5',
    'range':(2,0,2),
    'xaxis':'Bin',
    'fold':0

}
variables['b_pt100toINF_abseta0to2.4']={
    'name' : 'CleanJet_pt > 100. && abs(CleanJet_eta)<2.4 && Jet_hadronFlavour[CleanJet_jetIdx]==5',
    'range':(2,0,2),
    'xaxis':'Bin',
    'fold':0
...
variables['udsg_pt20to30_abseta1.6to2.4']={
    'name' : 'CleanJet_pt >20 && CleanJet_pt<=30 && abs(CleanJet_eta)>=1.6 && abs(CleanJet_eta)<2.4 && Jet_hadronFlavour[CleanJet_jetIdx]==0',
    'range':(2,0,2),
    'xaxis':'Bin',
    'fold':0

}
variables['udsg_pt30to40_abseta1.6to2.4']={
    'name' : 'CleanJet_pt >30  && CleanJet_pt<=40 && abs(CleanJet_eta)>=1.6 && abs(CleanJet_eta)<2.4 && Jet_hadronFlavour[CleanJet_jetIdx]==0',
    'range':(2,0,2),
    'xaxis':'Bin',
    'fold':0

}
variables['udsg_pt40to60_abseta1.6to2.4']={
    'name' : 'CleanJet_pt >40  && CleanJet_pt<=60 && abs(CleanJet_eta)>=1.6 && abs(CleanJet_eta)<2.4 && Jet_hadronFlavour[CleanJet_jetIdx]==0',
    'range':(2,0,2),
    'xaxis':'Bin',
    'fold':0

}
variables['udsg_pt60toINF_abseta1.6to2.4']={
    'name' : 'CleanJet_pt >60 && abs(CleanJet_eta)>=1.6 && abs(CleanJet_eta)<2.4 && Jet_hadronFlavour[CleanJet_jetIdx]==0',
    'range':(2,0,2),
    'xaxis':'Bin',
    'fold':0
