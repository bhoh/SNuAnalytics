...
InputFile_ele='rootFile_2017_SKIM7/PDF/results_unc.root'
...
#mkPlot.py --pycfg=configuration_withSig_ele.py --inputFile=$InputFile_ele --onlyPlot=cratio --scaleToPlot=1.7 --fileFormats=png,pdf
#mkPlot.py --pycfg=configuration_withSig_mu.py --inputFile=$InputFile_mu --onlyPlot=cratio --scaleToPlot=1.7 --fileFormats=png,pdf
