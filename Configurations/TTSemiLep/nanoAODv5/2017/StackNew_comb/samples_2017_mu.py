...
samples['TTLL+jj'] = {    'name'   :   getSampleFiles(directory,'TTTo2L2Nu_PSWeights',False,'nanoLatino_'),
                      'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*'+TTjj,
                      'FilesPerJob' : 7,
                    }
samples['TTLL+bj'] = {    'name'   :   getSampleFiles(directory,'TTTo2L2Nu_PSWeights',False,'nanoLatino_'),
                      'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*'+TTbj,
                      'FilesPerJob' : 7,
                    }
samples['TTLL+bb'] = {    'name'   :   getSampleFiles(directory,'TTTo2L2Nu_PSWeights',False,'nanoLatino_'),
                      'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*'+TTbb,
                      'FilesPerJob' : 7,
                    }

samples['TTLL+cc'] = {    'name'   :   getSampleFiles(directory,'TTTo2L2Nu_PSWeights',False,'nanoLatino_'),
