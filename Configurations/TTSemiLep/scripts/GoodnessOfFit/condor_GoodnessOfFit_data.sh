...
if [ $1 -eq 0 ]; then
  combine -M GoodnessOfFit --algorithm saturated -d $WORK_SPACE_DIR_75  -m 75 --setParameters $PARMS2,BR=0 --freezeParameters BR -n data --verbose 3
fi
if [ $1 -eq 1 ]; then
  combine -M GoodnessOfFit --algorithm saturated -d $WORK_SPACE_DIR_80  -m 80 --setParameters $PARMS2,BR=0 --freezeParameters BR -n data --verbose 3  
fi
if [ $1 -eq 2 ]; then
  combine -M GoodnessOfFit --algorithm saturated -d $WORK_SPACE_DIR_85  -m 85 --setParameters $PARMS2,BR=0 --freezeParameters BR -n data --verbose 3  
fi
if [ $1 -eq 3 ]; then
  combine -M GoodnessOfFit --algorithm saturated -d $WORK_SPACE_DIR_90  -m 90 --setParameters $PARMS2,BR=0 --freezeParameters BR -n data --verbose 3  
fi
if [ $1 -eq 4 ]; then
  combine -M GoodnessOfFit --algorithm saturated -d $WORK_SPACE_DIR_100  -m 100 --setParameters $PARMS2,BR=0 --freezeParameters BR -n data --verbose 3    
fi
if [ $1 -eq 5 ]; then
  combine -M GoodnessOfFit --algorithm saturated -d $WORK_SPACE_DIR_110  -m 110 --setParameters $PARMS2,BR=0 --freezeParameters BR -n data --verbose 3   
fi
if [ $1 -eq 6 ]; then
  combine -M GoodnessOfFit --algorithm saturated -d $WORK_SPACE_DIR_120  -m 120 --setParameters $PARMS2,BR=0 --freezeParameters BR -n data --verbose 3    
fi
if [ $1 -eq 7 ]; then
  combine -M GoodnessOfFit --algorithm saturated -d $WORK_SPACE_DIR_130  -m 130 --setParameters $PARMS2,BR=0 --freezeParameters BR -n data --verbose 3    
fi
if [ $1 -eq 8 ]; then
  combine -M GoodnessOfFit --algorithm saturated -d $WORK_SPACE_DIR_140  -m 140 --setParameters $PARMS2,BR=0 --freezeParameters BR -n data --verbose 3    
fi
if [ $1 -eq 9 ]; then
  combine -M GoodnessOfFit --algorithm saturated -d $WORK_SPACE_DIR_150  -m 150 --setParameters $PARMS2,BR=0 --freezeParameters BR -n data --verbose 3    
fi
if [ $1 -eq 10 ]; then
  combine -M GoodnessOfFit --algorithm saturated -d $WORK_SPACE_DIR_160  -m 160 --setParameters $PARMS2,BR=0 --freezeParameters BR -n data --verbose 3    
fi
