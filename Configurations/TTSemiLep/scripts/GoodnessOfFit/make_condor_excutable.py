...
commend  = '  combine -M GoodnessOfFit -d {WS} --toysFile higgsCombine{BR}.GenerateOnly.mH{MASS}.{SEED}.root -m {MASS} --algorithm saturated --toysFrequentist -t {N_TOYS} -n {BR} -s {SEED} --setParameters {PARAMS}'
end_if   = 'fi'
