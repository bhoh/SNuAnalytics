...
if [ $1 -eq 0 ]; then
  ...
  combineTool.py -M Impacts -d $WORK_SPACE_DIR_75  -m 75 -o impacts.json --exclude rgx{^prop_bin}
  plotImpacts.py -i impacts.json -o impacts_morphed_mH75  
fi
if [ $1 -eq 1 ]; then
  mkdir -p impact_morphed_mH80
  cd impact_morphed_mH80
  combineTool.py -M Impacts -d $WORK_SPACE_DIR_80  -m 80 -o impacts.json --exclude rgx{^prop_bin}
  plotImpacts.py -i impacts.json -o impacts_morphed_mH80 
fi
if [ $1 -eq 2 ]; then
  mkdir -p impact_morphed_mH85
  cd impact_morphed_mH85
  combineTool.py -M Impacts -d $WORK_SPACE_DIR_85  -m 85 -o impacts.json --exclude rgx{^prop_bin}
  plotImpacts.py -i impacts.json -o impacts_morphed_mH85 
fi
if [ $1 -eq 3 ]; then
  mkdir -p impact_morphed_mH90
  cd impact_morphed_mH90
  combineTool.py -M Impacts -d $WORK_SPACE_DIR_90  -m 90 -o impacts.json --exclude rgx{^prop_bin}
  plotImpacts.py -i impacts.json -o impacts_morphed_mH90 
fi
if [ $1 -eq 4 ]; then
  mkdir -p impact_morphed_mH100
  cd impact_morphed_mH100
  combineTool.py -M Impacts -d $WORK_SPACE_DIR_100  -m 100 -o impacts.json --exclude rgx{^prop_bin}
  plotImpacts.py -i impacts.json -o impacts_morphed_mH100 
fi
if [ $1 -eq 5 ]; then
  mkdir -p impact_morphed_mH110
  cd impact_morphed_mH110
  combineTool.py -M Impacts -d $WORK_SPACE_DIR_110  -m 110 -o impacts.json --exclude rgx{^prop_bin}
  plotImpacts.py -i impacts.json -o impacts_morphed_mH110 
fi
if [ $1 -eq 6 ]; then
  mkdir -p impact_morphed_mH120
  cd impact_morphed_mH120
  combineTool.py -M Impacts -d $WORK_SPACE_DIR_120  -m 120 -o impacts.json --exclude rgx{^prop_bin}
  plotImpacts.py -i impacts.json -o impacts_morphed_mH120 
fi
if [ $1 -eq 7 ]; then
  mkdir -p impact_morphed_mH130
  cd impact_morphed_mH130
  combineTool.py -M Impacts -d $WORK_SPACE_DIR_130  -m 130 -o impacts.json --exclude rgx{^prop_bin}
  plotImpacts.py -i impacts.json -o impacts_morphed_mH130 
fi
if [ $1 -eq 8 ]; then
  mkdir -p impact_morphed_mH140
  cd impact_morphed_mH140
  combineTool.py -M Impacts -d $WORK_SPACE_DIR_140  -m 140 -o impacts.json --exclude rgx{^prop_bin}
  plotImpacts.py -i impacts.json -o impacts_morphed_mH140 
fi
if [ $1 -eq 9 ]; then
  mkdir -p impact_morphed_mH150
  cd impact_morphed_mH150
  combineTool.py -M Impacts -d $WORK_SPACE_DIR_150  -m 150 -o impacts.json --exclude rgx{^prop_bin}
  plotImpacts.py -i impacts.json -o impacts_morphed_mH150 
fi
if [ $1 -eq 10 ]; then
  mkdir -p impact_morphed_mH160
  cd impact_morphed_mH160
  combineTool.py -M Impacts -d $WORK_SPACE_DIR_160  -m 160 -o impacts.json --exclude rgx{^prop_bin}
  plotImpacts.py -i impacts.json -o impacts_morphed_mH160 
fi
