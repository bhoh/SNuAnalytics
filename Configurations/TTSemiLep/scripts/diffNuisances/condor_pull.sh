...
if [ $1 -eq 3 ]; then
  combine -M FitDiagnostics -d $WORK_SPACE_DIR_90 -m 90 -n pull_90 --setParameters BR=0.000001 -t -1 --robustHesse 1 --robustFit 1 --setRobustFitTolerance 0.1 --stepSize 0.1 --rMin -1
fi
if [ $1 -eq 4 ]; then
  combine -M FitDiagnostics -d $WORK_SPACE_DIR_100 -m 100 -n pull_100 --setParameters BR=0.000001 -t -1 --robustHesse 1 --robustFit 1 --setRobustFitTolerance 0.1 --stepSize 0.1 --rMin -1
fi
if [ $1 -eq 5 ]; then
  combine -M FitDiagnostics -d $WORK_SPACE_DIR_110 -m 110 -n pull_110 --setParameters BR=0.000001 -t -1 --robustHesse 1 --robustFit 1 --setRobustFitTolerance 0.1 --stepSize 0.1 --rMin -1
fi
if [ $1 -eq 6 ]; then
  combine -M FitDiagnostics -d $WORK_SPACE_DIR_120 -m 120 -n pull_120 --setParameters BR=0.000001 -t -1 --robustHesse 1 --robustFit 1 --setRobustFitTolerance 0.1 --stepSize 0.1 --rMin -1
fi
if [ $1 -eq 7 ]; then
  combine -M FitDiagnostics -d $WORK_SPACE_DIR_130 -m 130 -n pull_130 --setParameters BR=0.000001 -t -1 --robustHesse 1 --robustFit 1 --setRobustFitTolerance 0.1 --stepSize 0.1 --rMin -1
fi
if [ $1 -eq 8 ]; then
  combine -M FitDiagnostics -d $WORK_SPACE_DIR_140 -m 140 -n pull_140 --setParameters BR=0.000001 -t -1 --robustHesse 1 --robustFit 1 --setRobustFitTolerance 0.1 --stepSize 0.1 --rMin -1
fi
if [ $1 -eq 9 ]; then
  combine -M FitDiagnostics -d $WORK_SPACE_DIR_150 -m 150 -n pull_150 --setParameters BR=0.000001 -t -1 --robustHesse 1 --robustFit 1 --setRobustFitTolerance 1 --stepSize 0.1 --rMin -1
fi
if [ $1 -eq 10 ]; then
  combine -M FitDiagnostics -d $WORK_SPACE_DIR_160 -m 160 -n pull_160 --setParameters BR=0.000001 -t -1 --robustHesse 1 --robustFit 1 --setRobustFitTolerance 0.1 --stepSize 0.1 --rMin -1
fi
