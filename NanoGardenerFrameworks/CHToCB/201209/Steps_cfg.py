...
def prepare_module_CHToCB_syst(base_name,syst_list,import_,declare_,module_):
    dictionary = {}
    for syst in syst_all:
      for j in ['Up','Down']:
        dictionary[base_name+ "_" + syst + j] = {
                  ...
                  'do4Data'    : False ,
                  'import'     : import_,
                  'declare'    : declare_.format(syst,j),
                  'module'     : module_.format(syst,j),
               }

    return dictionary

#def prepare_chain_CHToCB_syst(base_name, syst_name, syst_sub_list, up_down_list, selection):
#    dictionary = {}
#    ##make chain
#    dictionary[base_name+"_"+syst_name] = {
#                  'isChain'    : True,
#                  'do4MC'      : True ,
#                  'do4Data'    : False ,
#                  'subTargets': [base_name+"_" + syst + j for syst in syst_sub_list for j in up_down_list],
#                  'selection'  : selection,
...
def prepare_chain_CHToCB_syst(base_name, syst_name, module_list, syst_sub_list, up_down_list, selection):
    dictionary = {}
    if module_list == []:
    ...
    dictionary[base_name+"_"+syst_name] = {
                  ...
                  'do4MC'      : True ,
                  'do4Data'    : False ,
                  'subTargets': [module_name+"_" + syst + j for module_name in module_list for syst in syst_sub_list for j in up_down_list],
                  'selection'  : selection,
                  'outputbranchsel': os.getenv('CMSSW_BASE') + '/src/SNuAnalytics/NanoGardenerFrameworks/CHToCB/201209/rmBranchesSyst.txt'
               }
    return dictionary


def prepare_HEM_CHToCB_syst(base_name, import_, declare_, module_):
    dictionary = {}
    dictionary[base_name+ "_HEM"] = {
              'isChain'    : False,
              'do4MC'      : True ,
              'do4Data'    : False ,
              'import'     : import_,
    ...
    return dictionary
def prepare_HEM_chain_CHToCB_syst(base_name, modules, RunHEMweightMC, selection):
    dictionary = {}
    if RunHEMweightMC:
      subtargets = ["HEMweightMC"] + modules
    else:
      subtargets = modules
    dictionary[base_name+"_"+"jetMETSyst_HEM"] = {
                  'isChain'    : True,
                  'do4MC'      : True ,
                  'do4Data'    : False ,
...
def prepare_CHToCB_syst(base_name,selection):
    dictionary = {}
    ...
    for syst in syst_all:
      for j in ['Up','Down']:
        ...
        #dictionary['mvaTreeCHToCB_' + syst +j] = {
        #          'isChain'    : False ,
        #          'do4MC'      : True ,
        #          'do4Data'    : True,
        #          'import'     : 'LatinoAnalysis.NanoGardener.modules.mvaTreeCHToCB' ,
        #          'declare'    : 'mvaTreeCHToCB_{0}{1} = lambda : mvaTreeCHToCB(RPLME_YEAR,syst_suffix="{0}{1}")'.format(syst,j),
        #          'module'     : 'mvaTreeCHToCB_{0}{1}()',
        #       }
        #dictionary['mvaFillCHToCB_2018'] = {
        #          'isChain'    : False ,
        #          'do4MC'      : True ,
        #          'do4Data'    : True,
        #          'import'     : 'LatinoAnalysis.NanoGardener.modules.TMVAfiller_CHToCB' ,
        #          'declare'    : 'mvaFillCHToCB_2018_{0}{1} = lambda : TMVAfiller_CHToCB("data/MVA/CHToCB/mvaDict_2018.py",syst_suffix="{0}{1}")',
        #          'module'     : 'mvaFillCHToCB_2018_{0}{1}()',
        #       }
    ...
    dictionary[base_name+ "_HEM"] = {
              ...
              'do4Data'    : False ,
              'import'     : 'LatinoAnalysis.NanoGardener.modules.KinFitterProducer' ,
              'declare'    : 'kinFitting_HEM = lambda : KinFitterProducer(RPLME_YEAR,syst_suffix="HEM")',
              'module'     : 'kinFitting_HEM()',
           }
    dictionary[base_name+"_"+"jetMETSyst_HEM"] = {
                  'isChain'    : True,
                  'do4MC'      : True ,
                  'do4Data'    : False ,
                  'subTargets': ["HEMweightMC", base_name+"_HEM"],
                  'selection'  : selection,
                  'outputbranchsel': os.getenv('CMSSW_BASE') + '/src/SNuAnalytics/NanoGardenerFrameworks/CHToCB/201209/rmBranchesSyst.txt'
               }
    return dictionary
...
#               },
  ...
  'MCCorr2016v7' : {
                     ...
                     'do4MC'      : True  ,
                     'do4Data'    : False ,
                     'subTargets' : ['baseW','JERsMC2016','PrefCorr2016','JetPUID_SF_16',
                                     'trigMC','POGLeptonSF','rochesterMC','puW','l2Kin', 'l3Kin', 'l4Kin','formulasMCCHToCB','EmbeddingVeto'],
                },
  ...
  'CHToCBLepton2016v7' : {
                     ...
                     'do4MC'      : True  ,
                     'do4Data'    : False ,
                     'selection'  : '"Sum$(abs(Electron_eta)<2.5)+Sum$(abs(Muon_eta)<2.4)>0"' ,
                     'subTargets' : ['leptonMaker','POGLepSel','jetSelCustom',
                         'PromptParticlesGenVars','GenVar','GenLeptonMatch', 'TopGenVars'],
                     'outputbranchsel': os.getenv('CMSSW_BASE') + '/src/SNuAnalytics/NanoGardenerFrameworks/CHToCB/201209/rmBranches.txt'
                },


  'DATACHToCBLepton2016v7': {
                  'isChain'    : True  ,
                  'do4MC'      : False ,
                  'do4Data'    : True  ,
                  'selection'  : '"Sum$(abs(Electron_eta)<2.5)+Sum$(abs(Muon_eta)<2.4)>0"' ,
                  'subTargets' : ['leptonMaker','POGLepSel','jetSelCustom','CorrFatJetData','CleanFatJet', 'rochesterDATA' , 'l2Kin', 'l3Kin', 'l4Kin','trigData', 'formulasDATACHToCB'],
                  'outputbranchsel': os.getenv('CMSSW_BASE') + '/src/SNuAnalytics/NanoGardenerFrameworks/CHToCB/201209/rmBranches.txt'
                },
...
## ------- ChargedHiggsToCB
    ...
    'kinFitTTSemiLepV4_2018': {
                  ...
                  #XXX
                  #XXX
                  'selection'  : '"((Sum$(Jet_pt_nom[CleanJet_jetIdx] > 12. &&\
                                        abs(CleanJet_eta) < 2.4 &&\
    ...
    'genCHToCB' : {
                  ...
                  'declare'    : 'genCHToCB_ = lambda : genCHToCB(RPLME_YEAR)',
                  'module'     : 'genCHToCB_()',
               },
    ...
    'mvaTreeCHToCB_': {
                  ...
                  'import'     : 'LatinoAnalysis.NanoGardener.modules.mvaTreeCHToCB' ,
                  'declare'    : 'mvaTreeCHToCB__ = lambda : mvaTreeCHToCB(RPLME_YEAR,syst_suffix="nom",isSmear=False,genMatched=False)',
                  'module'     : 'mvaTreeCHToCB__()',
                  'onlySample'    : ['TT_TuneCUETP8M2T4','TTToSemiLeptonic','CHToCB_M075','CHToCB_M080','CHToCB_M085','CHToCB_M090','CHToCB_M100','CHToCB_M110','CHToCB_M120','CHToCB_M130','CHToCB_M140','CHToCB_M150','CHToCB_M160'],
    ...
    'mvaFillCHToCB_2018': {
                  ...
                  'do4Data'    : True,
                  'import'     : 'LatinoAnalysis.NanoGardener.modules.TMVAfiller_CHToCB' ,
                  'declare'    : 'mvaFillCHToCB_2018_ = lambda : TMVAfiller_CHToCB("data/MVA/CHToCB/mvaDict_2018.py")',
                  'module'     : 'mvaFillCHToCB_2018_()',
               },
    'mvaFillCHToCB_2017': {
                  'isChain'    : False ,
                  'do4MC'      : True ,
                  'do4Data'    : True,
                  'import'     : 'LatinoAnalysis.NanoGardener.modules.TMVAfiller_CHToCB' ,
                  'declare'    : 'mvaFillCHToCB_2017_ = lambda : TMVAfiller_CHToCB("data/MVA/CHToCB/mvaDict_2017.py")',
                  'module'     : 'mvaFillCHToCB_2017_()',
               },
    'mvaFillCHToCB_2016': {
                  'isChain'    : False ,
                  'do4MC'      : True ,
                  'do4Data'    : True,
                  'import'     : 'LatinoAnalysis.NanoGardener.modules.TMVAfiller_CHToCB' ,
                  'declare'    : 'mvaFillCHToCB_2016_ = lambda : TMVAfiller_CHToCB("data/MVA/CHToCB/mvaDict_2016.py")',
                  'module'     : 'mvaFillCHToCB_2016_()',
               },
  ...
  'MCCorr2016_hmumu' : {
    ...
    'HEMweightMC' : {
        ...
        'declare' : 'HEMVeto2018 = lambda : HEMweight(isData=False, dataYear=RPLME_YEAR,jetColl="Jet",cmssw = "Full2018",seed=65539)',
        'module'  : 'HEMVeto2018()'
    ...
    'HEMweightDATA' : {
        ...
        'do4Data'    : True  ,
        'import'  : 'LatinoAnalysis.NanoGardener.modules.HEMweight',
        'declare' : 'HEMVeto2018 = lambda : HEMweight(isData=True, dataYear=RPLME_YEAR,jetColl="Jet",cmssw = "Full2018",seed=65539)',
        'module'  : 'HEMVeto2018()'
   ...
   'CHToCBJetMETCorr2016v7': {
       ...
       'subTargets' : ['TopGenVars','MCCorr2016v7', 'CorrJetMC', 'CorrMET','HEMweightMC','ReduceStat'],
   },
   'CHToCBJetMETCorr2017v7': {
       ...
       'do4Data'    : False  ,
        #'selection'  :'"( (Lepton_pt[0]>20) && ( Alt$( Lepton_pt[1],-1) < 20 ) )"',
       'selection'  :'"( Sum$(CleanJet_pt > 10 && abs(CleanJet_eta) < 2.5) > 1 )"',
       'subTargets' : ['TopGenVars','MCCorr2017v7', 'CorrJetMC', 'CorrMET','HEMweightMC','ReduceStat'],
   },
   'CHToCBJetMETCorr2018v7': {
       ...
       'do4Data'    : False  ,
        #'selection'  :'"( (Lepton_pt[0]>20) && ( Alt$( Lepton_pt[1],-1) < 20 ) )"',
       'selection'  :'"( Sum$(CleanJet_pt > 10 && abs(CleanJet_eta) < 2.5) > 1 )"',
       'subTargets' : ['TopGenVars','MCCorr2018v7', 'CorrJetMC', 'CorrMET','HEMweightMC','ReduceStat'],
   },
  'CHToCBJetMETCorr_data' : {
       ...
       'do4Data'    : True  ,
       'selection'  :'"( Sum$(CleanJet_pt > 10 && abs(CleanJet_eta) < 2.5) > 1 )"',
       'subTargets' : ['CorrJetDATA','CorrMET','HEMweightDATA'],
       'outputbranchsel': os.getenv('CMSSW_BASE') + '/src/SNuAnalytics/NanoGardenerFrameworks/CHToCB/201008_CHToCBLepton/rmBranches.txt'
  },
...
### OLD stuff End
  ...
  'MCCorr2017v7' : {
                     ...
                     'subTargets' : ['baseW','JERsMC2017','PrefCorr2017','JetPUID_SF_17',
                                     'trigMC','POGLeptonSF','rochesterMC','puW','l2Kin', 'l3Kin', 'l4Kin','formulasMCCHToCB','EmbeddingVeto'],
                },
  ...
  'MCCorr2018v7' : {
                     ...
                     'do4MC'      : True  ,
                     'do4Data'    : False ,
                     'subTargets' : ['baseW','JERsMC2018','JetPUID_SF_18',
                                     'trigMC','POGLeptonSF','rochesterMC','puW','l2Kin', 'l3Kin', 'l4Kin','formulasMCCHToCB','EmbeddingVeto'],
                },
...
## ------- MODULES: Object Handling
  ...
  'leptonMaker': {
   ...
   'POGLepSel': {
                  ...
                  'do4Data'    : True  ,
                  'import'     : 'LatinoAnalysis.NanoGardener.modules.LeptonSel' ,
                  'declare'    : 'leptonSel_POG = lambda : LeptonSel("RPLME_CMSSW", "Loose", 1, "SNuAnalytics/NanoGardenerFrameworks/CHToCB/201209/POGLeptonSel_cfg.py")' ,
                  'module'     : 'leptonSel_POG()' ,
               },
...
## ------- MODULES: MC Weights
  ...
  'POGLeptonSF' : {
                  ...
                  'do4MC'      : True  ,
                  'do4Data'    : False  ,
                  'import'     : 'LatinoAnalysis.NanoGardener.modules.POGLeptonSFMaker' ,
                  'declare'    : 'POGLeptonSF = lambda : POGLeptonSFMaker("RPLME_CMSSW","SNuAnalytics/NanoGardenerFrameworks/CHToCB/201008_CHToCBLepton/POGLeptonSel_cfg.py")',
                  'module'     : 'POGLeptonSF()',
                },
...
# .... 2016/2017/... : switch in the code RPLME_YEAR
  ...
  'formulasMC' : {
   ...
   'formulasMCCHToCB' : {
                  ...
                  'import'     : 'LatinoAnalysis.NanoGardener.modules.GenericFormulaAdder' ,
                  'declare'    : '',
                  'module'     : 'GenericFormulaAdder(\'data/formulasToAdd_MC_CHToCB_RPLME_CMSSW.py\')' ,
                 },
  ...
  'formulasDATACHToCB' : {
                  ...
                  'import'     : 'LatinoAnalysis.NanoGardener.modules.GenericFormulaAdder' ,
                  'declare'    : '',
                  'module'     : 'GenericFormulaAdder(\'data/formulasToAdd_DATA_CHToCB_RPLME_CMSSW.py\')' ,
                 },
...
from LatinoAnalysis.NanoGardener.framework.samples.Run2016_102X_nAODv7 import Samples as DATA2016v7
from LatinoAnalysis.NanoGardener.framework.samples.Run2017_102X_nAODv7 import Samples as DATA2017v7
from LatinoAnalysis.NanoGardener.framework.samples.Run2018_102X_nAODv7 import Samples as DATA2018v7


##--Datasets  we are using
ALLDATAS=DATA2016v7.keys()+DATA2017v7.keys()+DATA2018v7.keys()
...
Steps.update(prepare_CHToCB_syst("kinFitTTSemiLepV4_2016",Steps['kinFitTTSemiLepV4_2016']['selection']))
Steps.update(prepare_CHToCB_syst("kinFitTTSemiLepV4_2017",Steps['kinFitTTSemiLepV4_2017']['selection']))
Steps.update(prepare_CHToCB_syst("kinFitTTSemiLepV4_2018",Steps['kinFitTTSemiLepV4_2018']['selection']))
...
for base_name in ["kinFitTTSemiLep_2016", "kinFitTTSemiLep_2017", "kinFitTTSemiLep_2018"] + ["kinFitTTSemiLepV4_2016", "kinFitTTSemiLepV4_2017", "kinFitTTSemiLepV4_2018"]:
  Steps.update(prepare_module_CHToCB_syst(base_name,
                       syst_all,
                       'LatinoAnalysis.NanoGardener.modules.KinFitterProducer',
                       'kinFitting_{0}{1} = lambda : KinFitterProducer(RPLME_YEAR,syst_suffix="{0}{1}")',
                       'kinFitting_{0}{1}()'
                       ))
  selection = Steps[base_name]['selection']
  Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_TotalUp',    [],  syst_tot,    ['Up'],   selection))
  Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_TotalDown',  [],  syst_tot,    ['Down'], selection))
  #Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_corrUp',     [],  syst_corr,   ['Up'],   selection))
  #Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_corrDown',   [],  syst_corr,   ['Down'], selection))
  #Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_uncorrUp',   [],  syst_uncorr, ['Up'],   selection))
  #Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_uncorrDown', [],  syst_uncorr, ['Down'], selection))
  Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_jesAbsolute_uncorr', [],  ['jesAbsolute_RPLME_YEAR'], ['Up','Down'], selection))
  Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_jesBBEC1_uncorr',    [],  ['jesBBEC1_RPLME_YEAR'], ['Up','Down'], selection))
  Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_jesEC2_uncorr',      [],  ['jesEC2_RPLME_YEAR'], ['Up','Down'], selection))
  Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_jesHF_uncorr',       [],  ['jesHF_RPLME_YEAR'], ['Up','Down'], selection))
  Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_jesRelativeSample_uncorr', [],  ['jesRelativeSample_RPLME_YEAR'], ['Up','Down'], selection))
  Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_jesAbsolute',              [],  ['jesAbsolute'], ['Up','Down'], selection))
  Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_jesBBEC1',                 [],  ['jesBBEC1'], ['Up','Down'], selection))
  Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_jesEC2',                   [],  ['jesEC2'], ['Up','Down'], selection))
  Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_jesFlavorQCD',             [],  ['jesFlavorQCD'], ['Up','Down'], selection))
  Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_jesHF',                    [],  ['jesHF'], ['Up','Down'], selection))
  Steps.update(prepare_chain_CHToCB_syst(base_name, 'jetMETSyst_jesRelativeBal',           [],  ['jesRelativeBal'], ['Up','Down'], selection))
#add HEM
Steps.update(prepare_HEM_CHToCB_syst("kinFitTTSemiLep_2018",
                        'LatinoAnalysis.NanoGardener.modules.KinFitterProducer',
                        'kinFitting_HEM = lambda : KinFitterProducer(RPLME_YEAR,syst_suffix="HEM")',
                        'kinFitting_HEM()',
                        ))
Steps.update(prepare_HEM_CHToCB_syst("kinFitTTSemiLepV4_2018",
                        'LatinoAnalysis.NanoGardener.modules.KinFitterProducer',
                        'kinFitting_HEM = lambda : KinFitterProducer(RPLME_YEAR,syst_suffix="HEM")',
                        'kinFitting_HEM()',
                        ))
...
Steps.update(prepare_HEM_chain_CHToCB_syst("kinFitTTSemiLepV4_2018",
                         ["kinFitTTSemiLepV4_2018_HEM"],
                         True,
                         Steps['kinFitTTSemiLepV4_2018']['selection']
                        ))
# add CHToCB syst. mvaTreeCHToCB
Steps.update(prepare_module_CHToCB_syst("mvaTreeCHToCB",
                       syst_all,
                       'LatinoAnalysis.NanoGardener.modules.mvaTreeCHToCB',
                       'mvaTreeCHToCB_{0}{1} = lambda : mvaTreeCHToCB(RPLME_YEAR,syst_suffix="{0}{1}")',
                       'mvaTreeCHToCB_{0}{1}()'
                       ))
# add CHToCB syst. mvaFillCHToCB
for year in ['2016','2017','2018']:
  base_name1 = 'mvaFillCHToCB_' + year
  Steps.update(prepare_module_CHToCB_syst(base_name1,
                       syst_all,
                       'LatinoAnalysis.NanoGardener.modules.TMVAfiller_CHToCB',
                       'mvaFillCHToCB_{year}_{0}{1} = lambda : TMVAfiller_CHToCB("data/MVA/CHToCB/mvaDict_{year}.py",syst_suffix="{0}{1}")'.format('{0}','{1}',year=year),
                       'mvaFillCHToCB_{year}_{0}{1}()'.format('{0}','{1}',year=year)
                       ))
  base_name2 = 'mvaCHToCB_' + year
  Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_TotalUp',    ['mvaTreeCHToCB',base_name1], syst_tot,    ['Up'],   '""'))
  Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_TotalDown',  ['mvaTreeCHToCB',base_name1], syst_tot,    ['Down'], '""'))
  #Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_corrUp',     ['mvaTreeCHToCB',base_name1], syst_corr,   ['Up'],   '""'))
  #Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_corrDown',   ['mvaTreeCHToCB',base_name1], syst_corr,   ['Down'], '""'))
  #Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_uncorrUp',   ['mvaTreeCHToCB',base_name1], syst_uncorr, ['Up'],   '""'))
  #Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_uncorrDown', ['mvaTreeCHToCB',base_name1], syst_uncorr, ['Down'], '""'))
  #
  Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_jesAbsolute_uncorr', ['mvaTreeCHToCB',base_name1],  ['jesAbsolute_RPLME_YEAR'], ['Up','Down'], '""'))
  Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_jesBBEC1_uncorr',    ['mvaTreeCHToCB',base_name1],  ['jesBBEC1_RPLME_YEAR'], ['Up','Down'], '""'))
  Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_jesEC2_uncorr',      ['mvaTreeCHToCB',base_name1],  ['jesEC2_RPLME_YEAR'], ['Up','Down'], '""'))
  Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_jesHF_uncorr',       ['mvaTreeCHToCB',base_name1],  ['jesHF_RPLME_YEAR'], ['Up','Down'], '""'))
  Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_jesRelativeSample_uncorr', ['mvaTreeCHToCB',base_name1],  ['jesRelativeSample_RPLME_YEAR'], ['Up','Down'], '""'))
  Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_jesAbsolute',              ['mvaTreeCHToCB',base_name1],  ['jesAbsolute'], ['Up','Down'], '""'))
  Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_jesBBEC1',                 ['mvaTreeCHToCB',base_name1],  ['jesBBEC1'], ['Up','Down'], '""'))
  Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_jesEC2',                   ['mvaTreeCHToCB',base_name1],  ['jesEC2'], ['Up','Down'], '""'))
  Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_jesFlavorQCD',             ['mvaTreeCHToCB',base_name1],  ['jesFlavorQCD'], ['Up','Down'], '""'))
  Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_jesHF',                    ['mvaTreeCHToCB',base_name1],  ['jesHF'], ['Up','Down'], '""'))
  Steps.update(prepare_chain_CHToCB_syst(base_name2, 'jetMETSyst_jesRelativeBal',           ['mvaTreeCHToCB',base_name1],  ['jesRelativeBal'], ['Up','Down'], '""'))

#add HEM
Steps.update(prepare_HEM_CHToCB_syst("mvaTreeCHToCB",
                        'LatinoAnalysis.NanoGardener.modules.mvaTreeCHToCB',
                        'mvaTreeCHToCB_HEM = lambda : mvaTreeCHToCB(RPLME_YEAR,syst_suffix="HEM")',
                        'mvaTreeCHToCB_HEM()'
                        ))
Steps.update(prepare_HEM_CHToCB_syst("mvaFillCHToCB_2018",
                       'LatinoAnalysis.NanoGardener.modules.TMVAfiller_CHToCB',
