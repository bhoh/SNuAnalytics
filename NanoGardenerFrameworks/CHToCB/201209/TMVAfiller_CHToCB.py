...
class TMVAfiller_CHToCB(Module):
    ...
    def analyze(self, event):
        ...
        if fillDummy:
          ...
          csv_jet0_mvaCHToCB_nom = getattr(event,'csv_jet0_mvaCHToCB_%s'%self._syst_suffix) 
          csv_jet1_mvaCHToCB_nom = getattr(event,'csv_jet1_mvaCHToCB_%s'%self._syst_suffix)
          csv_jet2_mvaCHToCB_nom = getattr(event,'csv_jet2_mvaCHToCB_%s'%self._syst_suffix)
          ...
          dijet_deltaR0_mvaCHToCB_nom        = getattr(event,'dijet_deltaR0_mvaCHToCB_%s'%self._syst_suffix)
          dijet_deltaR1_mvaCHToCB_nom        = getattr(event,'dijet_deltaR1_mvaCHToCB_%s'%self._syst_suffix)
          Hplus_b_deltaR0_mvaCHToCB_nom      = getattr(event,'Hplus_b_deltaR0_mvaCHToCB_%s'%self._syst_suffix)
          Hplus_b_deltaR1_mvaCHToCB_nom      = getattr(event,'Hplus_b_deltaR1_mvaCHToCB_%s'%self._syst_suffix)
          bb_deltaR_mvaCHToCB_nom            = getattr(event,'bb_deltaR_mvaCHToCB_%s'%self._syst_suffix)
          min_deltaR_bb_event_mvaCHToCB_nom  = getattr(event,'min_deltaR_bb_event_mvaCHToCB_%s'%self._syst_suffix)
          HT_btagged_M_nom                   = getattr(event,'HT_btagged_M_%s'%self._syst_suffix)
          HT_not_btagged_M_nom               = getattr(event,'HT_not_btagged_M_%s'%self._syst_suffix)
