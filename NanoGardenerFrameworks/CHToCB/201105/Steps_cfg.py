...
#               },
  ...
  'CHToCBLepton2016v7' : {
                     ...
                     'subTargets' : ['leptonMaker','POGLepSel','jetSelCustom',
                                     'GenLeptonMatch',
                                     #'baseW','JERsMC2016','btagPerJet2016','JetPUID_SF_16',
                                     'JERsMC2016','btagPerJet2016','JetPUID_SF_16',
                                     'rochesterMC','trigMC','POGLeptonSF','puW','l2Kin', 'l3Kin', 'l4Kin' ],
                     #'subTargets' : ['leptonMaker','POGLepSel','jetSelCustom',
                     #                'POGLeptonSF' ],
                },
  ...
  'DATACHToCBLepton2016v7': {
                  ...
                  'do4Data'    : True  ,
                  'selection'  : '"(nJet>1)"' ,
                  'subTargets' : ['leptonMaker','POGLepSel','jetSelCustom','CorrFatJetData','CleanFatJet', 'rochesterDATA' , 'l2Kin', 'l3Kin', 'l4Kin','trigData', 'formulasDATA'],
                },
  ...
  'CHToCBLepton2017v7' : {
                     ...
                     'subTargets' : ['leptonMaker','POGLepSel','jetSelCustom',
                                     'GenLeptonMatch',
                                     #'baseW','JERsMC2017','btagPerJet2017','JetPUID_SF_18',
                                     'JERsMC2017','btagPerJet2017','JetPUID_SF_18',
                                     'rochesterMC','trigMC','POGLeptonSF','puW','l2Kin', 'l3Kin', 'l4Kin' ],
                     #'subTargets' : ['leptonMaker','POGLepSel','jetSelCustom',
                     #                'POGLeptonSF' ],
                },
  ...
  'CHToCBLepton2018v7' : {
                     ...
                     'subTargets' : ['leptonMaker','POGLepSel','jetSelCustom',
                                     'GenLeptonMatch',
                                     'baseW','JERsMC2018','btagPerJet2018','JetPUID_SF_18',
                                     'rochesterMC','trigMC','POGLeptonSF','puW','l2Kin', 'l3Kin', 'l4Kin' ],
                     #'subTargets' : ['leptonMaker','POGLepSel','jetSelCustom',
                     #                'POGLeptonSF' ],
                },
...
## ------- ChargedHiggsToCB
  ...
  'MCCorr2016_hmumu' : {
   ...
   'CHToCBJetMETCorr': {
       ...
       'subTargets' : ['CorrJetMC', 'CorrMET','HEMweightMC'],
   },
  ...
  'CHToCBJetMETCorr_data' : {
       ...
       'do4MC'      : False  ,
       'do4Data'    : True  ,
       'selection'  :'"( Sum$(CleanJet_pt > 20 && abs(CleanJet_eta) < 2.5) > 1 )"',
...
## ------- MODULES: Object Handling
  ...
  'leptonMaker': {
   ...
   'POGLepSel': {
                  ...
                  'do4Data'    : True  ,
                  'import'     : 'LatinoAnalysis.NanoGardener.modules.LeptonSel' ,
                  'declare'    : 'leptonSel_POG = lambda : LeptonSel("RPLME_CMSSW", "Loose", 1, "SNuAnalytics/NanoGardenerFrameworks/CHToCB/201008_CHToCBLepton/POGLeptonSel_cfg.py")' ,
