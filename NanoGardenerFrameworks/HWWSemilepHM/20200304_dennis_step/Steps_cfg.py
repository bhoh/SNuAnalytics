...
## ------- HIGH MASS & VBS COMBINATION CHAINS:
    ...
    'MCCombJJLNu2016_2' : { 
                  ...
                  'do4Data'    : False ,
                  'selection'  : vbsjjlnu_preselection_mc_2016,
                  'subTargets' : ['wwNLOEWK','wzNLOEWK','zzNLOEWK','zNLOEWK','wNLOEWK', 'trigMC', 'CorrFatJetMC', 'CleanFatJet', 'whadJetSel', 'wlepMaker', 'BWReweight', 'HMlnjjVars'],
                  'onlySample' : vbsjjlnu_samples_bkg + vbsjjlnu_samples_signal + SemiLepHighMassSamples_2016
                   },
    ...
    'DATACombJJLNu2016_2' : { 
                  ...
                  'do4Data'    : True  ,
                  'selection'  : vbsjjlnu_preselection_data_2016,
                  'subTargets' : ['fakeWstep1l','CorrFatJetData', 'CleanFatJet', 'whadJetSel', 'wlepMaker', 'HMlnjjVars'],
                  'onlySample' : vbsjjlnu_samples_data2016
                   },
