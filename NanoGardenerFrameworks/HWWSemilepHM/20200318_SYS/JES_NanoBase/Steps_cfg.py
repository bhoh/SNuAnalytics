...
'SemilepNJetSkim':{
  ...
  'do4MC'      : True  ,
  'do4Data'    : False  ,
  'selection'  : '"((Sum$(CleanJet_pt > 20) > 1) || (nCleanFatJet > 0 ))"' 
...
'GetResolution_test':{
  ...
  'do4MC'      : True  ,
  'do4Data'    : True  ,
  'import'   : 'LatinoAnalysis.NanoGardener.modules.GetResolution' ,
  'declare'  : 'getResolution = lambda : GetResolution("2017")',
  'module'   : 'getResolution()',
  
},


  'HMSemilepSkimJHv6_7' : { ##To ReRun CleanFatJet
    'isChain'    : True  ,
    'do4MC'      : True  ,
    'do4Data'    : False  ,
    'selection'  :'"( (Lepton_pt[0]>20) && ( Alt$( Lepton_pt[1],-1) < 20 ) &&  (PuppiMET_pt > 20) )"',     

    'subTargets' : ['wwNLOEWK','wzNLOEWK','zzNLOEWK','zNLOEWK','wNLOEWK', 'CorrFatJetMC', 'CleanFatJet','HEMweightMC','trigMCKeepRun','trigMC_Cut' ],
  ...
  'HMSemilepSkimJHv6_7_data' : {
    'isChain'    : True  ,
    'do4MC'      : False  ,
    'do4Data'    : True  ,
    'selection'  :'"( (Lepton_pt[0]>20) && ( Alt$( Lepton_pt[1],-1) < 20 ) &&  (PuppiMET_pt > 20 ) )"',     
    'subTargets' : ['CorrFatJetData','CleanFatJet','HEMweightDATA'],
  },
  ##
...
#    def __init__(self, isData, dataYear, jetColl="CleanJet", cmssw = 'Full2016', seed=65539):
  'HEMvetoMC' :{#HEMveto.py##2018
    'isChain'    : False ,
    'do4MC'      : True  ,
    'do4Data'    : False  ,
    'import'  : 'LatinoAnalysis.NanoGardener.modules.HEMveto',
    'declare' : 'HEMVeto2018 = lambda : HEMveto(isData=False, dataYear=RPLME_YEAR,jetColl="CleanJet",cmssw = "Full2018",seed=65539)',
    'module'  : 'HEMVeto2018()'
...
#    def __init__(self, isData, dataYear, jetColl="CleanJet", cmssw = 'Full2016', seed=65539):
  ...
  'HEMweightDATA' :{#HEMweight.py##2018
    'isChain'    : False ,
    'do4MC'      : False  ,
    'do4Data'    : True  ,
    'import'  : 'LatinoAnalysis.NanoGardener.modules.HEMweight',
...
#                  } ,
  ...
  'HMlnjjVars_Dev_jhchoi' : {
    'isChain'    : False ,
    'do4MC'      : True ,
    'do4Data'    : True ,
    'import'     : 'LatinoAnalysis.NanoGardener.modules.HMlnjjVars_Dev_jhchoi',
...
##    def __init__(self,year,METtype='PuppiMET,',doSkim=False,doHardSkim=False):
  ...
  'HMlnjjVars_Dev_jhchoi2' : {
    'isChain'    : False ,
    'do4MC'      : True ,
    'do4Data'    : True ,
    'import'     : 'LatinoAnalysis.NanoGardener.modules.HMlnjjVars_Dev_jhchoi2',
    'declare'    : 'HMlnjjVars_Dev_jhchoi = lambda : HMlnjjVarsClass_Dev_jhchoi(RPLME_YEAR,METtype="PuppiMET")',
    'module' : 'HMlnjjVars_Dev_jhchoi()'
##    def __init__(self,year,METtype='PuppiMET,',doSkim=False,doHardSkim=False):
  ...
  'HMlnjjVars_Dev_jhchoi3' : {
    'isChain'    : False ,
    'do4MC'      : True ,
    'do4Data'    : True ,
    'import'     : 'LatinoAnalysis.NanoGardener.modules.HMlnjjVars_Dev_jhchoi3',
    'declare'    : 'HMlnjjVars_Dev_jhchoi = lambda : HMlnjjVarsClass_Dev_jhchoi(RPLME_YEAR,METtype="PuppiMET")',
    'module' : 'HMlnjjVars_Dev_jhchoi()'
##    def __init__(self,year,METtype='PuppiMET,',doSkim=False,doHardSkim=False):

  },
  'HMlnjjVars_Dev_jhchoi4' : {
    'isChain'    : False ,
    'do4MC'      : True ,
    'do4Data'    : True ,
    'import'     : 'LatinoAnalysis.NanoGardener.modules.HMlnjjVars_Dev_jhchoi4',
    'declare'    : 'HMlnjjVars_Dev_jhchoi = lambda : HMlnjjVarsClass_Dev_jhchoi(RPLME_YEAR,METtype="PuppiMET")',
    'module' : 'HMlnjjVars_Dev_jhchoi()'
##    def __init__(self,year,METtype='PuppiMET,',doSkim=False,doHardSkim=False):
  ...
  'HMlnjjVars_Dev_jhchoi5' : {
    'isChain'    : False ,
    'do4MC'      : True ,
    'do4Data'    : True ,
    'import'     : 'LatinoAnalysis.NanoGardener.modules.HMlnjjVars_Dev_jhchoi5',
    'declare'    : 'HMlnjjVars_Dev_jhchoi = lambda : HMlnjjVarsClass_Dev_jhchoi(RPLME_YEAR,METtype="PuppiMET")',
    'module' : 'HMlnjjVars_Dev_jhchoi()'
    ##    def __init__(self,year,METtype='PuppiMET,',doSkim=False,doHardSkim=False):
...
#               },
   ...
   'JESup' :   {  
                  ...
                  'do4MC'      : True  ,
                  'do4Data'    : False  ,
                  'subTargets' : ['JESBase','do_JESup','formulasMC'],
               },
...
## ------- MET
  ...
  'do_METdo_suffix' : {
   ...
   'METup_suffix' :   {
     ...
     #'outputbranchsel': os.getenv('CMSSW_BASE') + '/src/SNuAnalytics/NanoGardenerFrameworks/HWWSemilepHM/20200318_SYS/keepsysts_jhchoi.txt'
    'outputbranchsel': os.getenv('CMSSW_BASE') + '/src/LatinoAnalysis/NanoGardener/python/data/keepsysts.txt'
...
'CleanFatJet_JERup' : {
     ...
     'CleanFatJet_JERdo' : {
                  ...
                  'import'     : 'LatinoAnalysis.NanoGardener.modules.FatJetMaker',
                  # The branch prefix needs to be used if the CleanFatJet module is run on top of CorrFatJet* modules
                  'declare'    : 'fatjetMaker_jerdo = lambda : FatJetMaker( input_branch_prefix="jerTotalDown", jetid=0, minpt=200, maxeta=2.4, max_tau21=0.45, mass_range=[40, 250], over_lepR=0.8, over_jetR=0.8)',
