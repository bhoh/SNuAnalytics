...
while ANSWERED==0:
    ...
    want_remove=raw_input('want to condor_rm not-started-samples? (y/n)')
    print(want_remove)
...
while ANSWERED==0:
    ...
    want_resub=raw_input('want to add not-started-samples to Resub-List? (y/n)')
    print(want_resub)
...
while ANSWERED==0:
    ...
    want_resub=raw_input('want to add List-Running to Resub-List?, sometime this running is in Hold to be remove (y/n)')
    print(want_resub)
    if want_resub=='y' or want_resub=='n':
        ANSWERED=1
...
if want_resub=='y':
    ...
    LIST_RESUB.update(LIST_RUNNING)
...
want_resub='n'
while ANSWERED==0:
    want_resub=raw_input('want to resubmit Resub-List using condor_submit? (y/n)')
    print(want_resub)
    if want_resub=='y' or want_resub=='n':
        ANSWERED=1
...
for a in LIST_RESUB:
    ...
    curdir=os.getcwd()
    os.chdir(JOBDIR)
    os.system('rm -f '+a+'.err')
    os.system('rm -f '+a+'.out')
    os.system('rm -f '+a+'.log')
    os.system('rm -f '+a+'.jid')
