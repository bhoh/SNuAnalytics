...
ONLYSR=True
##----Configurations
AnaDir='/cms/ldap_home/jhchoi/HWW_Analysis/slc7/ForShape/CMSSW_10_2_19/src/SNuAnalytics/Configurations/HWWSemiLepHighMass/Full_v6Production/ForAN/FinalCombine_HPddt/'
def LoadCardPath(): 
