...
BKG=[ 'DY', 'MultiV', 'WpWmJJ_EWK_QCD_noHiggs', 'top', 'Wjets','vbfHWWlnuqq_M125','ggHWWlnuqq_M125','QCD_EM','QCD_MU','QCD_bcToE']
...
SIG=[]
for MX in LIST_MX:
   SIG.append('vbfHWWlnuqq_M'+str(MX))
   SIG.append('ggHWWlnuqq_M'+str(MX))
...
for shape in ROOT.gDirectory.GetListOfKeys():
   for proc in BKG+SIG:
      ...
      if proc in shapepath and shapepath!="histo_"+proc:
         print shapepath
