...
for MX in ${ARR_MASS[@]};do
	...
	for boost in ${ARR_BOOST[@]};do
		...
		for rg in ${ARR_REGION[@]};do
			...
			ARGUMENT="${ARGUMENT} ${flv}_${boost}_${proc}0_${rg}_${YEAR}=Datacard_M${MX}/${flv}CH__${boost}${proc}__${rg}__${cutname}__MEKDTAG/${FINALVAR}/datacard.txt"
			ARGUMENT="${ARGUMENT} ${flv}_${boost}_${proc}1_${rg}_${YEAR}=Datacard_M${MX}/${flv}CH__${boost}${proc}__${rg}__${cutname}__UNTAGGED/${FINALVAR}/datacard.txt"
		    else
			ARGUMENT="${ARGUMENT} ${flv}_${boost}_${proc}_${rg}_${YEAR}=Datacard_M${MX}/${flv}CH__${boost}${proc}__${rg}__${cutname}/${FINALVAR}/datacard.txt"
		    fi
    ...
    echo ${ARGUMENT}
    combineCards.py -S ${ARGUMENT} > combine_M${MX}_${YEAR}.txt
